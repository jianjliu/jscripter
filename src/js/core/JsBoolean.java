...
/**
 * <p>An <b>opaque</b> class representing JavaScript boolean objects.</p>
 *
 ...
 */
public class JsBoolean extends JsGlobal.Boolean.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsGlobal.Boolean.Prototype.Member
	{
		/**
		 ...
		 */
		@Override
		public JsBoolean with(ObjectLike o) {
			return new JsBoolean((JsObject)var(o).var(mid()));
		}
		 ...
		 */
		public final JsFunction.Member<JsBoolean> constructor = new JsFunction.Member<JsBoolean>(this, Members.constructor, Generic.get(JsBoolean.class));
	}

	/**
	 * <p>Internally constructs a boolean object.</p>
	 ...
	 * @javascript Re-compilers must report error on the invocation to an <b>internal</b> constructor. 
	 */
	protected JsBoolean(Object var) {
		super((JsObject)var);
	}
	/**
	 ...
	 */
	public JsBoolean(JsObject var) {
		super(var(var, (JsBoolean)null));
	}
	/**
	 * <p>Casts a boolean value to the current <b>opaque</b> type by wrapping it with the 
	 * wrapping constructor.</p>
	 * @param var The argument of a boolean.
	 * @since 1.0
	 * @javascript Re-compilers must ignore the construction operation of this constructor, 
	 * that is, replacing it with its only argument.
	 */
	public JsBoolean(Boolean var) {
		super(JsGlobal.Boolean.with().create(var));
	}
	/**
	 * <p>Casts a boolean value to the current <b>opaque</b> type by wrapping it with the 
	 * wrapping constructor.</p>
	 ...
	 * that is, replacing it with its only argument.
	 */
	public JsBoolean(Value<Boolean> var) {
		super(JsGlobal.Boolean.with().create(var));
	}
	 ...
	 */
	@Override
	public JsBoolean var() {
		return (JsBoolean)super.var();
	}
	/**
	 * <p>Assigns the value of another boolean instance to the current boolean object.</p>
	 * @param var The argument boolean instance.
	 ...
	 */
	public static final JsFunction.Member<JsBoolean> constructor = new JsFunction.Member<JsBoolean>(Members.constructor, Generic.get(JsBoolean.class));

	/**
	 * <p>Returns the primitive value associated with the current instance, if there is one.</p>
	 * @return The value of the current boolean instance.
	 * @see #toString()
	 * @since 1.0
	...
	/**
	 * <p>Inverts the boolean value of the current boolean instance, resembling the 
	 ...
	 * <pre>!b</pre>
	 * where <tt>b</tt> is the current boolean instance of the invocation of this method.
	 */
	...
	/**
	 * <p>Checks if the current boolean instance is an instance of the second operand, 
	 ...
	 * where <tt>a</tt> is the current instance of the invocation of this method.
	 */
	public final Boolean and(Value<Boolean> other) {
		return Js.and(this, other);
	}
	 ...
	 * where <tt>a</tt> is the current instance of the invocation of this method.
	 */
	public final JsBoolean or(Boolean other) {
		return Js.or(this, other);
	}
	 ...
	 * where <tt>a</tt> is the current instance of the invocation of this method.
	 */
	public final JsBoolean or(Value<Boolean> other) {
		return Js.or(this, other);
	}
	 ...
	 * where <tt>a</tt> is the current instance of the invocation of this method.
	 */
	public final JsBoolean or(JsBoolean other) {
		return Js.or(this, other);
	}
	 ...
	 * where <tt>a</tt> is the current instance of the invocation of this method.
	 */
	public final JsBoolean cond(Object test, JsBoolean other) {
		return Js.cond(test, this, other);
	}
}
