...
/**
 * <p>An <b>opaque</b> class representing JavaScript <tt>Error</tt>.</p>
 ...
 */
public class JsError extends JsGlobal.Error.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsGlobal.Error.Prototype.Members
	{
		/**
		 ...
		 */
		public final static Mid message = id("message");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and 
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
	 ...
	 * circumstances.
	 */
	public static class Member extends JsGlobal.Error.Prototype.Member
	{
		/**
		 ...
		 */
		@Override
		public JsError with(ObjectLike o) {
			return new JsError(super.with(o));
		}
		 ...
		 */
		public final JsFunction.Member<JsError> constructor = new JsFunction.Member<JsError>(this, Members.constructor, Generic.get(JsError.class));
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the 
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The <tt>message</tt> property of an <tt>Error</tt> object (or of an instance of any 
		 * subclass of <tt>Error</tt>) is intended to contain a human-readable string that provides 
		 * details about the error or exception that occurred. If a <tt>message</tt> argument is 
		 * passed to the <tt>Error()</tt> constructor, this message becomes the value of the <tt>message</tt> 
		 * property. If no <tt>message</tt> argument is passed, an <tt>Error</tt> object inherits 
		 * an implementation-defined default value (which may be the empty string) for this 
		 * property.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the 
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member message = new Value.String.Member(this, Members.message);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the 
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The <tt>name</tt> property of an <tt>Error</tt> object (or of an instance of 
		 * any subclass of <tt>Error</tt>) specifies the type of error or exception that 
		 * occurred. All <tt>Error</tt> objects inherit this property from their constructor. 
		 * The value of the property is the same as the name of the constructor. Thus 
		 * <tt>SyntaxError</tt> objects have a <tt>name</tt> property of "SyntaxError", and 
		 * <tt>EvalError</tt> objects have a <tt>name</tt> of "EvalError".</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the 
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
	 ...
	 */
	public static final JsFunction.Member<JsError> constructor = new JsFunction.Member<JsError>(Members.constructor, Generic.get(JsError.class));
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name 
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The <tt>message</tt> property of an <tt>Error</tt> object (or of an instance of any 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member message = new Value.String.Member(Members.message);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name 
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The <tt>name</tt> property of an <tt>Error</tt> object (or of an instance of 
	 ...
	 */
	@Override
	public JsError valueOf() {
		return new JsError((JsObject)var().valueOf());
	}
}
