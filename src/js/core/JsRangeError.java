...
/**
 * <p>An <b>opaque</b> class representing JavaScript <tt>RangeError</tt>.</p>
...
public class JsRangeError extends JsGlobal.RangeError.Prototype
{
	...
	public static class Member extends JsGlobal.RangeError.Prototype.Member
	{
		 ...
		 */
		public final JsFunction.Member<JsRangeError> constructor = new JsFunction.Member<JsRangeError>(this, Members.constructor, Generic.get(JsRangeError.class));
	}
	 ...
	 */
	public static final JsFunction.Member<JsRangeError> constructor = new JsFunction.Member<JsRangeError>(Members.constructor, Generic.get(JsRangeError.class));
