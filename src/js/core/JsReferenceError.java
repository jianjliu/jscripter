...
/**
 * <p>An <b>opaque</b> class representing JavaScript <tt>ReferenceError</tt>.</p>
 ...
 */
public class JsReferenceError extends JsGlobal.ReferenceError.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsGlobal.ReferenceError.Prototype.Member
	{
		/**
		 ...
		 */
		@Override
		public JsReferenceError with(ObjectLike o) {
			return new JsReferenceError(super.with(o));
		}
		 ...
		 */
		public final JsFunction.Member<JsReferenceError> constructor = new JsFunction.Member<JsReferenceError>(this, Members.constructor, Generic.get(JsReferenceError.class));
	}
	 ...
	 */
	public JsReferenceError(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final JsFunction.Member<JsReferenceError> constructor = new JsFunction.Member<JsReferenceError>(Members.constructor, Generic.get(JsReferenceError.class));
	 ...
	 */
	@Override
	public JsReferenceError valueOf() {
		return new JsReferenceError((JsObject)var().valueOf());
	}
}
