...
/**
 * <p>An <b>opaque</b> class representing JavaScript <tt>SyntaxError</tt>.</p>
 ...
 */
public class JsSyntaxError extends JsGlobal.SyntaxError.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsGlobal.SyntaxError.Prototype.Member
	{
		/**
		 ...
		 */
		@Override
		public JsSyntaxError with(ObjectLike o) {
			return new JsSyntaxError(super.with(o));
		}
		 ...
		 */
		public final JsFunction.Member<JsSyntaxError> constructor = new JsFunction.Member<JsSyntaxError>(this, Members.constructor, Generic.get(JsSyntaxError.class));
	}
	 ...
	 */
	public JsSyntaxError(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final JsFunction.Member<JsSyntaxError> constructor = new JsFunction.Member<JsSyntaxError>(Members.constructor, Generic.get(JsSyntaxError.class));
	 ...
	 */
	@Override
	public JsSyntaxError valueOf() {
		return new JsSyntaxError((JsObject)var().valueOf());
	}
}
