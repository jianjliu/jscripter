...
/**
 * <p>An <b>opaque</b> class representing JavaScript <tt>TypeError</tt>.</p>
 ...
 */
public class JsTypeError extends JsGlobal.TypeError.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsGlobal.TypeError.Prototype.Member
	{
		/**
		 ...
		 */
		@Override
		public JsTypeError with(ObjectLike o) {
			return new JsTypeError(super.with(o));
		}
		 ...
		 */
		public final JsFunction.Member<JsTypeError> constructor = new JsFunction.Member<JsTypeError>(this, Members.constructor, Generic.get(JsTypeError.class));
	}
	 ...
	 */
	public JsTypeError(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final JsFunction.Member<JsTypeError> constructor = new JsFunction.Member<JsTypeError>(Members.constructor, Generic.get(JsTypeError.class));
	 ...
	 */
	@Override
	public JsTypeError valueOf() {
		return new JsTypeError((JsObject)var().valueOf());
	}
}
