...
/**
 * <p>An <b>opaque</b> class representing JavaScript <tt>URIError</tt>.</p>
 * <p>An instance of this class is thrown by {@link js.Js#decodeURI(Object)} and 
 ...
 */
public class JsURIError extends JsGlobal.URIError.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsGlobal.URIError.Prototype.Member
	{
		/**
		 ...
		 */
		@Override
		public JsURIError with(ObjectLike o) {
			return new JsURIError(super.with(o));
		}
		 ...
		 */
		public final JsFunction.Member<JsURIError> constructor = new JsFunction.Member<JsURIError>(this, Members.constructor, Generic.get(JsURIError.class));
	}
	 ...
	 */
	public JsURIError(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final JsFunction.Member<JsURIError> constructor = new JsFunction.Member<JsURIError>(Members.constructor, Generic.get(JsURIError.class));
	 ...
	 */
	@Override
	public JsURIError valueOf() {
		return new JsURIError((JsObject)var().valueOf());
	}
}
