 ...
 * {@link JsClient#CSSRule} class.</p>
 * <p>An object of this class represents a rule in a CSS stylesheet. It represents style 
 * information to be applied to a specific set of document elements.</p>
 * <p>The DOM Level 2 CSS specification actually defines a complex hierarchy of CSSRule 
 * interfaces to represent different types of rules that can appear in a CSSStyleSheet. 
 * Style rules are the most common and most important types of rules in a stylesheet, 
 * and the property members of this class are the only ones that can be used portably 
 * across browsers.</p>
 *
 ...
 */
public class JsCSSRule extends JsClient.CSSRule.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.CSSRule.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsCSSRule#selectorText
		 * @see JsCSSRule.Member#selectorText
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid selectorText = id("selectorText");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsCSSRule#style
		 * @see JsCSSRule.Member#style
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.CSSRule.Prototype.Member
	{
		/**
		 ...
		 */
		public JsCSSRule with(ObjectLike o) {
			return new JsCSSRule(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsCSSRule} object 
		 * refers to the selector text that specifies the document elements the style 
		 * rule applies to. Setting the property throws a {@link JsDOMException} with 
		 * its {@link JsDOMException#code} property of the value {@link JsDOMException#NO_MODIFICATION_ALLOWED_ERR} 
		 * if the rule is read-only or the value {@link JsDOMException#SYNTAX_ERR} if 
		 * the new value does not follow CSS syntax rules.</p>
		 * @since 1.0
		 ...
		 */
		public final Value.String.Member selectorText = new Value.String.Member(this, Members.selectorText);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsCSSRule} object is 
		 * a read-only reference to the style values that should be applied to elements 
		 * specified by {@link #selectorText}.</p>
		 * <p>Note that while the property, identified by this member, is read-only 
		 * itself, the properties of the {@link JsCSS2Properties} object to which it 
		 * refers are read/write.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
	 ...
	 */
	public static final Value.String.Member selectorText = new Value.String.Member(Members.selectorText);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsCSSRule} object is 
	 ...
	 */
	public JsCSSRule valueOf() {
		return new JsCSSRule((JsObject)var().valueOf());
	}
}
