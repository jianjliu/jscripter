 ...
 * {@link JsClient#CanvasPattern} class.</p>
 * <p>An object of this opaque class is returned by the {@link JsCanvasRenderingContext2D#createPattern(JsHTMLCanvasElement, String)} 
 * or {@link JsCanvasRenderingContext2D#createPattern(JsHTMLImageElement, String)} method 
 * and  has no properties or methods of its own. It may be used as the value of the 
 * {@link JsCanvasRenderingContext2D#strokeStyle} and {@link JsCanvasRenderingContext2D#fillStyle} 
 * properties.</p>
 *
 ...
 */
public class JsCanvasPattern extends JsClient.CanvasPattern.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.CanvasPattern.Prototype.Member
	{
		/**
		 ...
		 */
		public JsCanvasPattern with(ObjectLike o) {
			return new JsCanvasPattern(super.with(o));
		}
	}
	 ...
	 */
	public JsCanvasPattern(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsCanvasPattern valueOf() {
		return new JsCanvasPattern((JsObject)var().valueOf());
	}
}
