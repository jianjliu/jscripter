 ...
 */
public class JsComment extends JsClient.Comment.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.Comment.Prototype.Member
	{
		/**
		 ...
		 */
		public JsComment with(ObjectLike o) {
			return new JsComment(super.with(o));
		}
	}
	 ...
	 */
	public JsComment valueOf() {
		return new JsComment((JsObject)var().valueOf());
	}
}
