 ...
 * {@link JsClient#DocumentFragment} class.</p>
 * <p>An object of this class represents a portion or fragment of a document. More 
 * specifically, it has a list of adjacent nodes and all descendants of each, but without 
 * any common parent node. A node of this class is never part of a document tree, and 
 * the inherited {@link JsNode#parentNode} property is always <tt>null</tt>. However, 
 * nodes of this class exhibit a special behavior that makes them quite useful: when a 
 * request is made to insert a node of this class into a document tree, it is not the 
 * node itself that is inserted but it is instead each child of the node. This makes 
 * it useful as a temporary place-holder for nodes that you wish to insert, all at once, 
 * into a document. A node of this class is also particularly useful for implementing 
 * document cut, copy, and paste operations, particularly when combined with the {@link JsRange} 
 * class.</p>
 * <p>You can create a new, empty node of this class with {@link JsDocument#createDocumentFragment()}, 
 * or you can use {@link JsRange#extractContents()} or {@link JsRange#cloneContents()} to 
 * obtain a node of {@link JsDocumentFragment} that contains a fragment of an existing 
 * document.</p>
 ...
 */
public class JsDocumentFragment extends JsClient.DocumentFragment.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.DocumentFragment.Prototype.Member
	{
		/**
		 ...
		 */
		public JsDocumentFragment with(ObjectLike o) {
			return new JsDocumentFragment(super.with(o));
		}
	}
	 ...
	 */
	public JsDocumentFragment(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsDocumentFragment valueOf() {
		return new JsDocumentFragment((JsObject)var().valueOf());
	}
}
