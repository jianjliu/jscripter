 ...
 * {@link JsClient#DocumentType} class.</p>
 * <p>This infrequently used class represents the DTD of an XML document. Programmers 
 * working exclusively with HTML documents never need to use this class.</p>
 * <p>Because a DTD is not part of a document's content, {@link JsDocumentType} nodes 
 * never appear in the document tree. If an XML document has a DTD, the {@link JsDocumentType} 
 * node for that DTD is available through the {@link JsDocument#doctype} property of the 
 * {@link JsDocument} node.</p>
 * <p>Although the W3C DOM includes an API for accessing the XML entities and notations 
 * defined in a DTD, typical web browsers do not parse the DTDs for the documents they 
 * load, and client-side JavaScript, including JS, can not access those entities and 
 * notations. For client-side JS programming, this <b>opaque</b> class represents only 
 * the contents of the <tt>&lt;!DOCTYPE&gt;</tt> tag, not the contents of the DTD file 
 * it references.</p>
 * <p>Nodes of this class are immutable and may not be modified in any way.</p>
 *
 ...
 */
public class JsDocumentType extends JsClient.DocumentType.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.DocumentType.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsDocumentType#internalSubset
		 * @see JsDocumentType.Member#internalSubset
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid internalSubset = id("internalSubset");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsDocumentType#name
		 * @see JsDocumentType.Member#name
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsDocumentType#publicId
		 * @see JsDocumentType.Member#publicId
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsDocumentType#systemId
		 * @see JsDocumentType.Member#systemId
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.DocumentType.Prototype.Member
	{
		/**
		 ...
		 */
		public JsDocumentType with(ObjectLike o) {
			return new JsDocumentType(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsDocumentType} 
		 * object is a read-only reference to the unparsed text of the internal subset 
		 * of the DTD, that is, the portion of the DTD that appears in the document 
		 * itself rather than in an external file. The delimiting square brackets of the 
		 * internal subset are not part of the returned value. If there is no internal 
		 * subset, the property is <tt>null</tt>.</p>
		 * @since 1.0
		 ...
		 */
		public final Value.String.Member internalSubset = new Value.String.Member(this, Members.internalSubset);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsDocumentType} 
		 * object is a read-only reference to the name of the document type. It is the 
		 * identifier that immediately follows <tt>&lt;!DOCTYPE&gt;</tt> at the start of 
		 * an XML document and is the same as the tag name of the document's root element.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsDocumentType} 
		 * object is a read-only reference to the public identifier of the external 
		 * subset of the DTD, or <tt>null</tt> if none is specified.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsDocumentType} 
		 * object is a read-only reference to the system identifier of the external 
		 * subset of the DTD, or <tt>null</tt> if none is specified.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
	 ...
	 */
	public JsDocumentType(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final Value.String.Member internalSubset = new Value.String.Member(Members.internalSubset);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsDocumentType} 
	 ...
	 */
	public JsDocumentType valueOf() {
		return new JsDocumentType((JsObject)var().valueOf());
	}
}
