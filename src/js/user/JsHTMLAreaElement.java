 ...
 * {@link JsClient#HTMLAreaElement} class.</p>
 * <p>This class represents an image map area 
 ...
 */
public class JsHTMLAreaElement extends JsClient.HTMLAreaElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLAreaElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLAreaElement#accessKey
		 * @see JsHTMLAreaElement.Member#accessKey
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLAreaElement#alt
		 * @see JsHTMLAreaElement.Member#alt
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLAreaElement#coords
		 * @see JsHTMLAreaElement.Member#coords
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLAreaElement#href
		 * @see JsHTMLAreaElement.Member#href
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLAreaElement#noHref
		 * @see JsHTMLAreaElement.Member#noHref
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid noHref    = id("noHref"   );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLAreaElement#shape
		 * @see JsHTMLAreaElement.Member#shape
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLAreaElement#tabIndex
		 * @see JsHTMLAreaElement.Member#tabIndex
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLAreaElement#target
		 * @see JsHTMLAreaElement.Member#target
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLAreaElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLAreaElement with(ObjectLike o) {
			return new JsHTMLAreaElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLAreaElement} 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLAreaElement} 
		 * object refers to boolean value specifying whether this area is inactive, that is, 
		 * has no associated action.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Boolean.Member noHref = new Value.Boolean.Member(this, Members.noHref);
	}
	 ...
	 */
	public JsHTMLAreaElement(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Boolean.Member noHref = new Value.Boolean.Member(Members.noHref);
	 ...
	 */
	public final JsHTMLAreaElement valueOf() {
		return new JsHTMLAreaElement((JsObject)var().valueOf());
	}
}
