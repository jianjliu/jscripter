 ...
 * {@link JsClient#HTMLBaseElement} class.</p>
 * <p>This class represents a base element defining Document base URI 
 ...
 */
public class JsHTMLBaseElement extends JsClient.HTMLBaseElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLBaseElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLBaseElement#href
		 * @see JsHTMLBaseElement.Member#href
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLBaseElement#target
		 * @see JsHTMLBaseElement.Member#target
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLBaseElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLBaseElement with(ObjectLike o) {
			return new JsHTMLBaseElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLBaseElement} 
	 ...
	 */
	public JsHTMLBaseElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLBaseElement valueOf() {
		return new JsHTMLBaseElement((JsObject)var().valueOf());
	}
}
