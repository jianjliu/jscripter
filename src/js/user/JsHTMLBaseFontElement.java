 ...
 * {@link JsClient#HTMLBaseFontElement} class.</p>
 * <p>This class represents a base font element 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;basefont&gt;</tt> tag which is deprecated by HTML 4.01 and should be handled by 
 * style sheets.</p> 
 *
 ...
 */
public class JsHTMLBaseFontElement extends JsClient.HTMLBaseFontElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLBaseFontElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLBaseFontElement#color
		 * @see JsHTMLBaseFontElement.Member#color
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLBaseFontElement#face
		 * @see JsHTMLBaseFontElement.Member#face
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid face  = id("face" );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLBaseFontElement#size
		 * @see JsHTMLBaseFontElement.Member#size
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLBaseFontElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLBaseFontElement with(ObjectLike o) {
			return new JsHTMLBaseFontElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLBaseFontElement} 
		 * object refers to a string specifying the font color.</p>
		 * <p>This attribute is deprecated by HTML 4.01 along with the <tt>&lt;basefont&gt;</tt> tag.</p> 
		 * @since 1.0
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLBaseFontElement} 
		 * object refers to a string specifying a comma-separated list of font identifiers 
		 * the web browser should search for in order of preference.</p>
		 * <p>This attribute is deprecated by HTML 4.01 along with the <tt>&lt;basefont&gt;</tt> tag.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member face  = new Value.String.Member(this, Members.face );
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLBaseFontElement} 
		 * object refers to a string specifying the font size.</p>
		 * <p>This attribute is deprecated by HTML 4.01 along with the <tt>&lt;basefont&gt;</tt> tag.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
	 ...
	 */
	public JsHTMLBaseFontElement(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member face  = new Value.String.Member(Members.face );
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLBaseFontElement} 
	 ...
	 */
	public final JsHTMLBaseFontElement valueOf() {
		return new JsHTMLBaseFontElement((JsObject)var().valueOf());
	}
}
