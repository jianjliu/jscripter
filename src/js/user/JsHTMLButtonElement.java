 ...
 * {@link JsClient#HTMLButtonElement} class.</p>
 * <p>This class represents a graphical push button 
 * in an HTML page, or a {@link JsHTMLElement} object created by the HTML 
 * <tt>&lt;button&gt;</tt> tag or <tt>&lt;input&gt;</tt> tag with its <tt>type</tt> 
 * attribute of the value "button".</p>
 * <p>An input element of this class created by the HTML <tt>&lt;input&gt;</tt> tag 
 * with {@link JsHTMLInputElement#type} of "button" is a graphical push button that 
 * displays the plain text specified by the {@link JsHTMLInputElement#value} property. 
 * The button has no default behavior and must be given an {@link JsHTMLInputElement#onclick} 
 * event handler in order to be useful. For buttons that submit or reset a form, use a 
 * {@link JsHTMLInputElement#type} of "submit" or "reset". Note that the HTML <tt>&lt;button&gt;</tt> 
 * tag can create buttons that display arbitrary HTML instead of plain text.</p>
 *
 ...
 */
public class JsHTMLButtonElement extends JsClient.HTMLButtonElement.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLButtonElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLButtonElement with(ObjectLike o) {
			return new JsHTMLButtonElement(super.with(o));
		}
	}
	 ...
	 */
	public JsHTMLButtonElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsHTMLButtonElement valueOf() {
		return new JsHTMLButtonElement((JsObject)var().valueOf());
	}
}
