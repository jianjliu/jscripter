 ...
 * {@link JsClient#HTMLCheckBoxElement} class.</p>
 * <p>This class represents a push button 
 * in an HTML page, or a {@link JsHTMLInputElement} object created by the HTML 
 * <tt>&lt;input&gt;</tt> tag with its <tt>type</tt> 
 * attribute of the value "checkbox".</p>
 * <p>An input element of this class displays a toggle button that the user can check 
 * and uncheck. The {@link JsHTMLInputElement#checked} property holds the current state 
 * of the button, and the {@link JsHTMLInputElement#onclick} event handler is triggered 
 * whenever this value changes. The {@link JsHTMLInputElement#onchange} handler may 
 * also be triggered by some browsers in this case. The {@link JsHTMLInputElement#value} 
 * property is an internal value for submission to a web server and is not displayed to 
 * the user.</p>
 * <p>To associate a label with an input element of type, simply place the label text 
 * after the <tt>&lt;input&gt;</tt> tag, optionally using a <tt>&lt;label&gt;</tt> tag.</p>
 * <p>Input elements of this type often appear in groups, and the members of a group 
 * are sometimes given the same {@link JsHTMLInputElement#name} property and different 
 * {@link JsHTMLInputElement#value} properties, for the convenience of the web server 
 * to which the {@link JsHTMLInputElement#form} is submitted.</p> 
 *
 ...
 */
public class JsHTMLCheckBoxElement extends JsClient.HTMLCheckBoxElement.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLCheckBoxElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLCheckBoxElement with(ObjectLike o) {
			return new JsHTMLCheckBoxElement(super.with(o));
		}
	}
	 ...
	 */
	public JsHTMLCheckBoxElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsHTMLCheckBoxElement valueOf() {
		return new JsHTMLCheckBoxElement((JsObject)var().valueOf());
	}
}
