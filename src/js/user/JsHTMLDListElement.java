 ...
 * {@link JsClient#HTMLDListElement} class.</p>
 * <p>This class represents a definition list 
 ...
 */
public class JsHTMLDListElement extends JsClient.HTMLDListElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLDListElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLDListElement#compact
		 * @see JsHTMLDListElement.Member#compact
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLDListElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLDListElement with(ObjectLike o) {
			return new JsHTMLDListElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLDListElement} 
	 ...
	 */
	public JsHTMLDListElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLDListElement valueOf() {
		return new JsHTMLDListElement((JsObject)var().valueOf());
	}
}
