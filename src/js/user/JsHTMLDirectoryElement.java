 ...
 * {@link JsClient#HTMLDirectoryElement} class.</p>
 * <p>This class represents a directory list 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;dir&gt;</tt> tag which is deprecated by HTML 4.01.</p>
 * <p>The <tt>&lt;dir&gt;</tt> element was designed to be used for creating multi-column 
 * directory lists. The <tt>&lt;menu&gt;</tt> element was designed to be used for single 
 * column menu lists. Both elements have the same structure as <tt>&lt;ul&gt;</tt>, just 
 * different rendering. In practice, a web browser will render a <tt>&lt;dir&gt;</tt> or 
 * <tt>&lt;menu&gt;</tt> list exactly as a <tt>&lt;ul&gt;</tt> list. Using <tt>&lt;ul&gt;</tt> 
 * instead is strongly recommended by HTML 4.01.</p>
 *
 ...
 */
public class JsHTMLDirectoryElement extends JsClient.HTMLDirectoryElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLDirectoryElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLDirectoryElement#compact
		 * @see JsHTMLDirectoryElement.Member#compact
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLDirectoryElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLDirectoryElement with(ObjectLike o) {
			return new JsHTMLDirectoryElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLDirectoryElement} 
		 ...
		 * <p>This attribute is deprecated by HTML 4.01 along with the <tt>&lt;dir&gt;</tt> tag.</p> 
		 * @since 1.0
	 ...
	 */
	public JsHTMLDirectoryElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLDirectoryElement valueOf() {
		return new JsHTMLDirectoryElement((JsObject)var().valueOf());
	}
}
