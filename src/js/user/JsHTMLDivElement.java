 ...
 * {@link JsClient#HTMLDivElement} class.</p>
 * <p>This class represents a generic block container 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;div&gt;</tt> tag which, in conjunction with the <tt>id</tt> and <tt>class</tt> 
 * attributes, offers a generic mechanism for adding structure to documents. These 
 * elements define content to be block-level but impose no other presentational idioms 
 * on the content. Thus, HTML authors may use these elements in conjunction with style 
 * sheets, the <tt>lang</tt> attribute, etc., to tailor HTML to their own needs and 
 * tastes.</p> 
 *
 ...
 */
public class JsHTMLDivElement extends JsClient.HTMLDivElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLDivElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLDivElement#align
		 * @see JsHTMLDivElement.Member#align
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLDivElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLDivElement with(ObjectLike o) {
			return new JsHTMLDivElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLDivElement} 
	 ...
	 */
	public JsHTMLDivElement(JsObject var) {
		super(var);
	}
	 ...
	 * <p>The property, identified by this member, of a {@link JsHTMLDivElement} 
	 * object refers to a string specifying the horizontal alignment of the element 
	 * with respect to the surrounding context. Possible values are:</p>
	 * <ul>
	 * <li><tt>"left"</tt>: text lines are rendered flush left.</li>
	 * <li><tt>"center"</tt>: text lines are centered.</li>
	 * <li><tt>"right"</tt>: text lines are rendered flush right.</li>
	 ...
	 */
	public final JsHTMLDivElement valueOf() {
		return new JsHTMLDivElement((JsObject)var().valueOf());
	}
}
