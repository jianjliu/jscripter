 ...
 * {@link JsClient#HTMLFieldSetElement} class.</p>
 * <p>This class represents a fieldset element 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;fieldset&gt;</tt> tag which organizes form controls into logical groups.</p> 
 *
 ...
 */
public class JsHTMLFieldSetElement extends JsClient.HTMLFieldSetElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLFieldSetElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLFieldSetElement#form
		 * @see JsHTMLFieldSetElement.Member#form
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLFieldSetElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLFieldSetElement with(ObjectLike o) {
			return new JsHTMLFieldSetElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLFieldSetElement} 
		 * object is a read-only reference to the {@link JsHTMLFormElement} object containing 
		 * this control. The property returns <tt>null</tt> if this control is not within 
		 * the context of a form.</p> 
		 * @since 1.0
	 ...
	 */
	public JsHTMLFieldSetElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLFieldSetElement valueOf() {
		return new JsHTMLFieldSetElement((JsObject)var().valueOf());
	}
}
