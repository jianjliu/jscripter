 ...
 * {@link JsClient#HTMLFileUploadElement} class.</p>
 * <p>This class represents a file select control 
 * in an HTML page, or a {@link JsHTMLInputElement} object created with the HTML 
 * <tt>&lt;input&gt;</tt> tag with its <tt>type</tt> 
 * attribute of the value "file" whose {@link JsHTMLInputElement#value} attribute may be 
 * used as the initial file name by the web browser.</p>
 * <p>An input element of this class consists of a text input field for entering the 
 * name of a file, along with a button that opens a file-selection dialog box for 
 * graphical selection of a file. The {@link JsHTMLInputElement#value} property holds 
 * the name of the file the user has specified, but when the {@link JsHTMLInputElement#form} 
 * containing the file-upload element is submitted, the browser sends the contents of 
 * the selected file to the server instead of just sending the filename. For this to 
 * work, the {@link JsHTMLInputElement#form} must use "multipart/form-data" encoding 
 * and the POST method.</p>
 * <p>For security, an input element of this type does not allow HTML authors or script 
 * programmers to specify a default filename. The HTML <tt>value</tt> attribute is 
 * ignored, and the {@link JsHTMLInputElement#value} property is read-only for this 
 * type of element, which means that only the user may enter a filename. When the user 
 * selects or edits a filename, the file-upload element triggers the {@link JsHTMLInputElement#onchange} 
 * event handler.</p>
 *  
 ...
 */
public class JsHTMLFileUploadElement extends JsClient.HTMLFileUploadElement.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLFileUploadElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLFileUploadElement with(ObjectLike o) {
			return new JsHTMLFileUploadElement(super.with(o));
		}
	}
	 ...
	 */
	public JsHTMLFileUploadElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsHTMLFileUploadElement valueOf() {
		return new JsHTMLFileUploadElement((JsObject)var().valueOf());
	}
}
