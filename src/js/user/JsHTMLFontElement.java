 ...
 * {@link JsClient#HTMLFontElement} class.</p>
 * <p>This class represents a font element 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;font&gt;</tt> tag which is deprecated by HTML 4.01 and should be handled by 
 * style sheets.</p> 
 *
 ...
 */
public class JsHTMLFontElement extends JsClient.HTMLFontElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLFontElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLFontElement#color
		 * @see JsHTMLFontElement.Member#color
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLFontElement#face
		 * @see JsHTMLFontElement.Member#face
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLFontElement#size
		 * @see JsHTMLFontElement.Member#size
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLFontElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLFontElement with(ObjectLike o) {
			return new JsHTMLFontElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLFontElement} 
		 * object refers to a string specifying the font color.</p>
		 * <p>This attribute is deprecated by HTML 4.01 along with the <tt>&lt;font&gt;</tt> tag.</p> 
		 * @since 1.0
	 ...
	 */
	public JsHTMLFontElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLFontElement valueOf() {
		return new JsHTMLFontElement((JsObject)var().valueOf());
	}
}
