 ...
 * {@link JsClient#HTMLFrameSetElement} class.</p>
 * <p>This class represents a form set 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;frameset&gt;</tt> tag.</p> 
 *
 ...
 */
public class JsHTMLFrameSetElement extends JsClient.HTMLFrameSetElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLFrameSetElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLFrameSetElement#cols
		 * @see JsHTMLFrameSetElement.Member#cols
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLFrameSetElement#rows
		 * @see JsHTMLFrameSetElement.Member#rows
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLFrameSetElement#onload
		 * @see JsHTMLFrameSetElement.Member#onload
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLFrameSetElement#onunload
		 * @see JsHTMLFrameSetElement.Member#onunload
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLFrameSetElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLFrameSetElement with(ObjectLike o) {
			return new JsHTMLFrameSetElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLFrameSetElement} 
		 * object refers to a string specifying the layout of vertical frames with a 
		 * comma-separated list of pixels, percentages, and relative lengths. The 
		 * default value is 100%, meaning one column.</p> 
		 * @since 1.0
		 ...
		 */
		public final Value.String.Member cols = new Value.String.Member(this, Members.cols);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLFrameSetElement} 
		 * object refers to a string specifying the layout of horizontal frames with a 
		 * comma-separated list of pixels, percentages, and relative lengths. The 
		 * default value is 100%, meaning one row.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member rows = new Value.String.Member(this, Members.rows);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLFrameSetElement} object is a 
		 * reference to an event handler function invoked when the web browser finishes 
		 * loading all frames within the frame-set.</p> 
		 * @since 1.0
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLFrameSetElement} object is a 
		 * reference to an event handler function invoked when the web browser removes 
		 * a document from the frame-set.</p> 
		 * @since 1.0
		 * @see JsElement#addEventListener(String, JsFunction, Boolean)
		 * @see JsElement#attachEvent(String, JsFunction)
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 ...
		 * qualifying member with a dot in between.
		 */
		public final JsFunction.Member<?> onunload = new JsFunction.Member<Object>(this, Members.onunload);
	}
	 ...
	 */
	public JsHTMLFrameSetElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final Value.String.Member cols = new Value.String.Member(Members.cols);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLFrameSetElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member rows = new Value.String.Member(Members.rows);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLFrameSetElement} object is a 
	 ...
	 * identifier of the field name.
	 */
	public static final JsFunction.Member<?> onunload = new JsFunction.Member<Object>(Members.onunload);
	 ...
	 */
	public final JsHTMLFrameSetElement valueOf() {
		return new JsHTMLFrameSetElement((JsObject)var().valueOf());
	}
}
