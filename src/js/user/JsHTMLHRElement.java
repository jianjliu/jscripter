 ...
 * {@link JsClient#HTMLHRElement} class.</p>
 * <p>This class represents a horizontal rule 
 ...
 */
public class JsHTMLHRElement extends JsClient.HTMLHRElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLHRElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLHRElement#align
		 * @see JsHTMLHRElement.Member#align
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLHRElement#noShade
		 * @see JsHTMLHRElement.Member#noShade
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid noShade = id("noShade");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLHRElement#size
		 * @see JsHTMLHRElement.Member#size
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLHRElement#width
		 * @see JsHTMLHRElement.Member#width
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLHRElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLHRElement with(ObjectLike o) {
			return new JsHTMLHRElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLHRElement} 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLHRElement} 
		 * object refers to a string specifying the height of the rule. The default 
		 * value for this attribute depends on the web browser.</p> 
		 * <p>This attribute is deprecated by HTML 4.01 and should be handled by style sheets.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLHRElement} 
		 * object refers to a string specifying the width of the rule. The default 
		 * width is "100%", that is., the rule extends across the entire canvas.</p> 
		 * <p>This attribute is deprecated by HTML 4.01 and should be handled by style sheets.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLHRElement} 
		 * object refers to a boolean value indicates the web browser that there should 
		 * be no shading in the rendering of this element.</p> 
		 * <p>This attribute is deprecated by HTML 4.01 and should be handled by style sheets.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Boolean.Member noShade = new Value.Boolean.Member(this, Members.noShade);
	}
	 ...
	 */
	public JsHTMLHRElement(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Boolean.Member noShade = new Value.Boolean.Member(Members.noShade);
	 ...
	 */
	public final JsHTMLHRElement valueOf() {
		return new JsHTMLHRElement((JsObject)var().valueOf());
	}
}
