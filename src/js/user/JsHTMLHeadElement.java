 ...
 * {@link JsClient#HTMLHeadElement} class.</p>
 * <p>This class represents the document head 
 ...
 */
public class JsHTMLHeadElement extends JsClient.HTMLHeadElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLHeadElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLHeadElement#profile
		 * @see JsHTMLHeadElement.Member#profile
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid profile = id("profile");
	}
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLHeadElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLHeadElement with(ObjectLike o) {
			return new JsHTMLHeadElement(super.with(o));
		}
		 ...
		 * object refers to a string specifying the location of one or more meta data 
		 * profiles, separated by white space. For future extensions, web browsers 
		 * should consider the value to be a list even though the current HTML 
		 * specification only considers the first URI to be significant.</p> 
		 * @since 1.0
		 ...
		 */
		public final Value.String.Member profile = new Value.String.Member(this, Members.profile);
	}
	 ...
	 */
	public JsHTMLHeadElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final Value.String.Member profile = new Value.String.Member(Members.profile);
	 ...
	 */
	public final JsHTMLHeadElement valueOf() {
		return new JsHTMLHeadElement((JsObject)var().valueOf());
	}
}
