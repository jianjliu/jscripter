 ...
 * {@link JsClient#HTMLHiddenElement} class.</p>
 ...
 * attribute of the value "hidden".</p>
 * <p>An input element of this type is, in fact, hidden. The {@link JsHTMLInputElement#value} 
 * property of this invisible form element holds an arbitrary string to be submitted to 
 * the web server. Use an element of this type if you want to submit data that the user 
 * did not input directly.</p>
 *  
 ...
 */
public class JsHTMLHiddenElement extends JsClient.HTMLHiddenElement.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLHiddenElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLHiddenElement with(ObjectLike o) {
			return new JsHTMLHiddenElement(super.with(o));
		}
	}
	 ...
	 */
	public JsHTMLHiddenElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsHTMLHiddenElement valueOf() {
		return new JsHTMLHiddenElement((JsObject)var().valueOf());
	}
}
