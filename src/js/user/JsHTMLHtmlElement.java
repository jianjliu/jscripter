 ...
 * {@link JsClient#HTMLHtmlElement} class.</p>
 * <p>This class represents the root 
 * of an HTML document, or a {@link JsHTMLElement} object created with the 
 * <tt>&lt;html&gt;</tt> tag.</p> 
 *
 ...
 */
public class JsHTMLHtmlElement extends JsClient.HTMLHtmlElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLHtmlElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLHtmlElement#version
		 * @see JsHTMLHtmlElement.Member#version
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid version = id("version");
	}
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLHtmlElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLHtmlElement with(ObjectLike o) {
			return new JsHTMLHtmlElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLHtmlElement} 
		 * object refers to a string specifying which HTML DTD version that governs the 
		 * current document.</p>
		 * <p>This attribute has been deprecated because it is redundant with version 
		 * information provided by the document type declaration.</p> 
		 * @since 1.0
		 ...
		 */
		public final Value.String.Member version = new Value.String.Member(this, Members.version);
	}
	 ...
	 */
	public JsHTMLHtmlElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final Value.String.Member version = new Value.String.Member(Members.version);
	 ...
	 */
	public final JsHTMLHtmlElement valueOf() {
		return new JsHTMLHtmlElement((JsObject)var().valueOf());
	}
}
