 ...
 * {@link JsClient#HTMLIsIndexElement} class.</p>
 * <p>This class represents a single-line text input element 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * tag <tt>&lt;isindex&gt;</tt> which is deprecated by HTML 4.01 and should be handled 
 * by a {@link JsHTMLTextFieldElement} object created by the HTML <tt>&lt;input&gt;</tt> 
 * tag with its <tt>type</tt> attribute of the value "text".</p> 
 *
 ...
 */
public class JsHTMLIsIndexElement extends JsClient.HTMLIsIndexElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLIsIndexElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLIsIndexElement#form
		 * @see JsHTMLIsIndexElement.Member#form
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLIsIndexElement#prompt
		 * @see JsHTMLIsIndexElement.Member#prompt
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLIsIndexElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLIsIndexElement with(ObjectLike o) {
			return new JsHTMLIsIndexElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLIsIndexElement} 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLIsIndexElement} 
		 * object refers a string specifying the prompt message for the input field.</p>
		 ...
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member prompt = new Value.String.Member(this, Members.prompt);
	}
	 ...
	 */
	public JsHTMLIsIndexElement(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member prompt = new Value.String.Member(Members.prompt);
	 ...
	 */
	public final JsHTMLIsIndexElement valueOf() {
		return new JsHTMLIsIndexElement((JsObject)var().valueOf());
	}
}
