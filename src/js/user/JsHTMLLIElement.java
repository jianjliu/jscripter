 ...
 * {@link JsClient#HTMLLIElement} class.</p>
 * <p>This class represents a list item 
 ...
 */
public class JsHTMLLIElement extends JsClient.HTMLLIElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLLIElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLLIElement#type
		 * @see JsHTMLLIElement.Member#type
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLLIElement#value
		 * @see JsHTMLLIElement.Member#value
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLLIElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLLIElement with(ObjectLike o) {
			return new JsHTMLLIElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLLIElement} 
		 * object refers to a string specifying the type of bullet style of this list 
		 * item. See {@link JsHTMLOListElement#type} and {@link JsHTMLUListElement#type} 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLLIElement} 
		 * object refers to an integer value that resets its sequence number when used 
		 * in an ordered list, that is, a {@link JsHTMLOListElement} object.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Number.Member value = new Value.Number.Member(this, Members.value);
	}
	 ...
	 */
	public JsHTMLLIElement(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Number.Member value = new Value.Number.Member(Members.value);
	 ...
	 */
	public final JsHTMLLIElement valueOf() {
		return new JsHTMLLIElement((JsObject)var().valueOf());
	}
}
