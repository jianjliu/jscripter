 ...
 * {@link JsClient#HTMLLabelElement} class.</p>
 * <p>This class represents a label for a form control that does not have an implicit label 
 ...
 */
public class JsHTMLLabelElement extends JsClient.HTMLLabelElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLLabelElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLLabelElement#form
		 * @see JsHTMLLabelElement.Member#form
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLLabelElement#accessKey
		 * @see JsHTMLLabelElement.Member#accessKey
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLLabelElement#htmlFor
		 * @see JsHTMLLabelElement.Member#htmlFor
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLLabelElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLLabelElement with(ObjectLike o) {
			return new JsHTMLLabelElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLLabelElement} 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLLabelElement} 
		 * object refers to a string that mirrors the <tt>for</tt> attribute for the 
		 * <tt>&lt;label&gt;</tt> tag and links the label with another form control by 
	 ...
	 */
	public JsHTMLLabelElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLLabelElement valueOf() {
		return new JsHTMLLabelElement((JsObject)var().valueOf());
	}
}
