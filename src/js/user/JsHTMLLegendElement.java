 ...
 * {@link JsClient#HTMLLegendElement} class.</p>
 * <p>This class represents a legend element 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * tag <tt>&lt;legend&gt;</tt> which provides a caption for a {@link JsHTMLFieldSetElement} grouping.</p> 
 *
 ...
 */
public class JsHTMLLegendElement extends JsClient.HTMLLegendElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLLegendElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLLegendElement#form
		 * @see JsHTMLLegendElement.Member#form
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLLegendElement#accessKey
		 * @see JsHTMLLegendElement.Member#accessKey
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLLegendElement#align
		 * @see JsHTMLLegendElement.Member#align
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLLegendElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLLegendElement with(ObjectLike o) {
			return new JsHTMLLegendElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLLegendElement} 
	 ...
	 */
	public JsHTMLLegendElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLLegendElement valueOf() {
		return new JsHTMLLegendElement((JsObject)var().valueOf());
	}
}
