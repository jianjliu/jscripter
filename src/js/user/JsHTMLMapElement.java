 ...
 * {@link JsClient#HTMLMapElement} class.</p>
 * <p>This class represents a client-side image map 
 ...
 */
public class JsHTMLMapElement extends JsClient.HTMLMapElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLMapElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLMapElement#areas
		 * @see JsHTMLMapElement.Member#areas
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid areas = id("areas");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLMapElement#name
		 * @see JsHTMLMapElement.Member#name
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLMapElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLMapElement with(ObjectLike o) {
			return new JsHTMLMapElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLMapElement} object 
		 * is a read-only reference to an array of all {@link JsHTMLAreaElement} objects 
		 * defined for the image map.</p> 
		 * @since 1.0
		 ...
		 */
		public final JsHTMLCollection.Member<JsHTMLAreaElement> areas = new JsHTMLCollection.Member<JsHTMLAreaElement>(this, Members.areas);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLMapElement} 
		 * object refers to the name of the image map for use with {@link JsHTMLImageElement#useMap}.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
	 ...
	 */
	public JsHTMLMapElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final JsHTMLCollection.Member<JsHTMLAreaElement> areas = new JsHTMLCollection.Member<JsHTMLAreaElement>(Members.areas);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLMapElement} 
	 ...
	 */
	public final JsHTMLMapElement valueOf() {
		return new JsHTMLMapElement((JsObject)var().valueOf());
	}
}
