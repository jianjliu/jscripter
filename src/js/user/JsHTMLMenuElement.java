 ...
 * {@link JsClient#HTMLMenuElement} class.</p>
 * <p>This class represents a menu list 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;menu&gt;</tt> tag which is deprecated by HTML 4.01.</p>
 ...
 */
public class JsHTMLMenuElement extends JsClient.HTMLMenuElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLMenuElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLMenuElement#compact
		 * @see JsHTMLMenuElement.Member#compact
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLMenuElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLMenuElement with(ObjectLike o) {
			return new JsHTMLMenuElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLMenuElement} 
		 ...
		 * <p>This attribute is deprecated by HTML 4.01 along with the <tt>&lt;menu&gt;</tt> tag.</p> 
		 * @since 1.0
	 ...
	 */
	public JsHTMLMenuElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLMenuElement valueOf() {
		return new JsHTMLMenuElement((JsObject)var().valueOf());
	}
}
