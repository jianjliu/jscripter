 ...
 * {@link JsClient#HTMLMetaElement} class.</p>
 * <p>This class represents a meta element 
 * in an HTML document, or a {@link JsHTMLElement} object created with the HTML 
 * tag <tt>&lt;meta&gt;</tt> which lets the HTML authors specify meta data, information 
 * about the HTML document rather than document content, in a variety of ways.</p> 
 *
 ...
 */
public class JsHTMLMetaElement extends JsClient.HTMLMetaElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLMetaElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLMetaElement#content
		 * @see JsHTMLMetaElement.Member#content
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLMetaElement#httpEquiv
		 * @see JsHTMLMetaElement.Member#httpEquiv
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid httpEquiv = id("httpEquiv");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLMetaElement#name
		 * @see JsHTMLMetaElement.Member#name
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLMetaElement#scheme
		 * @see JsHTMLMetaElement.Member#scheme
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid scheme    = id("scheme"   );
	}
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLMetaElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLMetaElement with(ObjectLike o) {
			return new JsHTMLMetaElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLMetaElement} 
		 * object refers to a string specifying information associated with {@link #name}.</p> 
		 * @since 1.0
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLMetaElement} 
		 * object refers to a string specifying the HTTP response header name used by the 
		 * HTTP servers to gather information for HTTP response message headers.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member httpEquiv = new Value.String.Member(this, Members.httpEquiv);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLMetaElement} 
		 * object refers to a string specifying the name of the meta information.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLMetaElement} 
		 * object refers to a string specifying the name of a scheme to be used to 
		 * interpret {@link #content}.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member scheme    = new Value.String.Member(this, Members.scheme   );
	}
	 ...
	 */
	public JsHTMLMetaElement(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member httpEquiv = new Value.String.Member(Members.httpEquiv);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLMetaElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member scheme    = new Value.String.Member(Members.scheme   );
	 ...
	 */
	public final JsHTMLMetaElement valueOf() {
		return new JsHTMLMetaElement((JsObject)var().valueOf());
	}
}
