 ...
 * {@link JsClient#HTMLModElement} class.</p>
 * <p>This class represents a notice of modification to part of  
 * an HTML document, or a {@link JsHTMLElement} object created with the HTML 
 * tag <tt>&lt;del&gt;</tt> and <tt>&lt;ins&gt;</tt> which are used to markup sections 
 * of the document that have been inserted or deleted with respect to a different 
 ...
 */
public class JsHTMLModElement extends JsClient.HTMLModElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLModElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLModElement#cite
		 * @see JsHTMLModElement.Member#cite
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid cite     = id("cite"    );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLModElement#dateTime
		 * @see JsHTMLModElement.Member#dateTime
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid dateTime = id("dateTime");
	}
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLModElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLModElement with(ObjectLike o) {
			return new JsHTMLModElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLModElement} 
		 * object refers to a URI string that designates a source document or message. 
		 * This attribute is intended to point to information that describes the reason 
		 * for the change.</p> 
		 * @since 1.0
		 ...
		 */
		public final Value.String.Member cite     = new Value.String.Member(this, Members.cite    );
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLModElement} 
		 * object refers to a string specifying the date and time when the change was 
		 * made.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member dateTime = new Value.String.Member(this, Members.dateTime);
	}
	 ...
	 */
	public JsHTMLModElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final Value.String.Member cite     = new Value.String.Member(Members.cite    );
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLModElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member dateTime = new Value.String.Member(Members.dateTime);
	 ...
	 */
	public final JsHTMLModElement valueOf() {
		return new JsHTMLModElement((JsObject)var().valueOf());
	}
}
