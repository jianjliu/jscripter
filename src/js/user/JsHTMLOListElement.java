 ...
 * {@link JsClient#HTMLOListElement} class.</p>
 * <p>This class represents an ordered list 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;ol&gt;</tt> tag.</p> 
 *
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 * @see JsHTMLDListElement
 * @see JsHTMLUListElement
 *
 ...
 */
public class JsHTMLOListElement extends JsClient.HTMLOListElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLOListElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLOListElement#compact
		 * @see JsHTMLOListElement.Member#compact
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid compact = id("compact");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLOListElement#start
		 * @see JsHTMLOListElement.Member#start
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid start   = id("start"  );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLOListElement#type
		 * @see JsHTMLOListElement.Member#type
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLOListElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLOListElement with(ObjectLike o) {
			return new JsHTMLOListElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLOListElement} 
		 * object refers to a boolean value specifying whether to reduce interitem spacing, 
		 * giving a hint to visual browsers to render the list in a more compact way.</p>
		 ...
		 */
		public final Value.Boolean.Member compact = new Value.Boolean.Member(this, Members.compact);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLOListElement} 
		 * object refers to an integer value specifying the starting number of the first 
		 * item in an ordered list. The default starting number is "1". Note that while 
		 * the value of this attribute is an integer, the corresponding label may be 
		 * non-numeric. Thus, when the list item style is uppercase latin letters (A, B, C, ...), 
		 * the value 3 means "C". When the style is lowercase roman numerals, 3 means 
		 * "iii", etc.</p>
		 * <p>This attribute is deprecated by HTML 4.01 and should be handled by style sheets.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 ...
		 * qualifying member with a dot in between.
		 */
		public final Value.Number.Member start = new Value.Number.Member(this, Members.start);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLUListElement} 
		 * object refers to a string specifying the type of the ordered list. Possible 
		 * values for the type attribute are case-sensitive. The values and their meanings 
		 * are:
		 * <ul>
		 * <li><tt>"1"</tt>: arabic numbers like 1, 2, 3, ...</li>
		 * <li><tt>"a"</tt>: lower alphabetics like a, b, c, ...</li>
		 * <li><tt>"A"</tt>: upper alphabetics like A, B, C, ...</li>
		 * <li><tt>"i"</tt>: lower romans like i, ii, iii, ...</li>
		 * <li><tt>"I"</tt>: upper romans like I, II, III, ...</li>
		 * </ul>
		 * <p>This attribute is deprecated by HTML 4.01 and should be handled by style sheets.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
	 ...
	 */
	public JsHTMLOListElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final Value.Boolean.Member compact = new Value.Boolean.Member(Members.compact);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLOListElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Number.Member start = new Value.Number.Member(Members.start);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLUListElement} 
	 ...
	 */
	public final JsHTMLOListElement valueOf() {
		return new JsHTMLOListElement((JsObject)var().valueOf());
	}
}
