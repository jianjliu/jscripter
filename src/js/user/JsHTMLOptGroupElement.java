 ...
 * {@link JsClient#HTMLOptGroupElement} class.</p>
 * <p>This class represents an option group 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;optgroup&gt;</tt> tag which allows HTML authors to group choices logically.</p> 
 * <p>The HTML <tt>&lt;optgroup&gt;</tt> tag is particularly helpful when the user must 
 * choose from a long list of options; groups of related choices are easier to grasp and 
 * remember than a single long list of options. In HTML 4, all OPTGROUP elements must be 
 * specified directly within a SELECT element, that is, groups may not be nested.</p> 
 *
 ...
 */
public class JsHTMLOptGroupElement extends JsClient.HTMLOptGroupElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLOptGroupElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLOptGroupElement#disabled
		 * @see JsHTMLOptGroupElement.Member#disabled
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLOptGroupElement#label
		 * @see JsHTMLOptGroupElement.Member#label
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLOptGroupElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLOptGroupElement with(ObjectLike o) {
			return new JsHTMLOptGroupElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLOptGroupElement} 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLOptGroupElement} 
		 * object refers to a string value that assigns a label to the option group.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
	 ...
	 */
	public JsHTMLOptGroupElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLOptGroupElement valueOf() {
		return new JsHTMLOptGroupElement((JsObject)var().valueOf());
	}
}
