 ...
 * {@link JsClient#HTMLOptionElement} class.</p>
 * <p>This class represents a selectable choice 
 ...
 */
public class JsHTMLOptionElement extends JsClient.HTMLOptionElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLOptionElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLOptionElement#defaultSelected
		 * @see JsHTMLOptionElement.Member#defaultSelected
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid defaultSelected  = id("defaultSelected");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLOptionElement#disabled
		 * @see JsHTMLOptionElement.Member#disabled
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLOptionElement#form
		 * @see JsHTMLOptionElement.Member#form
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLOptionElement#index
		 * @see JsHTMLOptionElement.Member#index
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLOptionElement#label
		 * @see JsHTMLOptionElement.Member#label
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid label            = id("label"          );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLOptionElement#selected
		 * @see JsHTMLOptionElement.Member#selected
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid selected         = id("selected"       );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLOptionElement#text
		 * @see JsHTMLOptionElement.Member#text
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLOptionElement#value
		 * @see JsHTMLOptionElement.Member#value
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLOptionElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLOptionElement with(ObjectLike o) {
			return new JsHTMLOptionElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
		 * object refers to a boolean value that represents the value of the HTML 
		 * <tt>selected</tt> attribute. The value of this attribute does not change if 
		 * the state of the corresponding form control, in an interactive browser, 
		 * changes.</p> 
		 * @since 1.0
		 ...
		 */
		public final Value.Boolean.Member defaultSelected  = new Value.Boolean.Member(this, Members.defaultSelected);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
		 * object refers to a boolean value that specifies whether the control is 
		 * unavailable in this context.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
		 * object refers to a boolean value that represents the current state of the 
		 * corresponding form control, in an interactive browser. Changing this attribute 
		 * changes the state of the form control, but does not change the value of the 
		 * HTML <tt>selected</tt> attribute of the element.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Boolean.Member selected         = new Value.Boolean.Member(this, Members.selected       );
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
		 * object refers to an integer value specifying the index of this option element 
		 * in its parent {@link JsHTMLSelectElement} element, starting from 0.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Number.Member index = new Value.Number.Member(this, Members.index);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
		 * object refers to a string value specifying the option label for use in 
		 ...
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member label = new Value.String.Member(this, Members.label);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
		 * object refers to a string value specifying the text contained within the 
		 * option element.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
		 * object refers to a string value specifying the current form control value.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
	 ...
	 */
	public JsHTMLOptionElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final Value.Boolean.Member defaultSelected  = new Value.Boolean.Member(Members.defaultSelected);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Boolean.Member selected         = new Value.Boolean.Member(Members.selected       );
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Number.Member index = new Value.Number.Member(Members.index);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member label = new Value.String.Member(Members.label);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLOptionElement} 
	 ...
	 */
	public JsHTMLOptionElement valueOf() {
		return new JsHTMLOptionElement((JsObject)var().valueOf());
	}
}
