 ...
 * {@link JsClient#HTMLParagraphElement} class.</p>
 * <p>This class represents a paragraph 
 ...
 */
public class JsHTMLParagraphElement extends JsClient.HTMLParagraphElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLParagraphElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLParagraphElement#align
		 * @see JsHTMLParagraphElement.Member#align
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLParagraphElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLParagraphElement with(ObjectLike o) {
			return new JsHTMLParagraphElement(super.with(o));
		}
	 ...
	 */
	public JsHTMLParagraphElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLParagraphElement valueOf() {
		return new JsHTMLParagraphElement((JsObject)var().valueOf());
	}
}
