 ...
 * {@link JsClient#HTMLParamElement} class.</p>
 * <p>This class represents a parameter fed to the {@link JsHTMLObjectElement} element 
 ...
 */
public class JsHTMLParamElement extends JsClient.HTMLParamElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLParamElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLParamElement#name
		 * @see JsHTMLParamElement.Member#name
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLParamElement#type
		 * @see JsHTMLParamElement.Member#type
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLParamElement#value
		 * @see JsHTMLParamElement.Member#value
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLParamElement#valueType
		 * @see JsHTMLParamElement.Member#valueType
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid valueType = id("valueType");
	}
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLParamElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLParamElement with(ObjectLike o) {
			return new JsHTMLParamElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLParagraphElement} 
		 * object refers to a string specifying the name of the run-time parameter, 
		 * assumed to be known by the inserted object. Whether the property name is 
		 * case-sensitive depends on the specific object implementation.</p> 
		 * @since 1.0
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLParagraphElement} 
		 * object refers to a string specifying the content type of the resource designated 
		 * by the {@link #value} attribute only in the case where {@link #valueType} is 
		 * set to "ref". This attribute thus specifies for the browser, the type of 
		 * values that will be found at the URI designated by {@link #value}.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLParagraphElement} 
		 * object refers to a string specifying the value of the run-time parameter 
		 * specified by {@link #name}. Property values have no meaning to HTML; their 
		 * meaning is determined by the object in question.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLParagraphElement} 
		 * object refers to a string specifying the type information about the meaning of 
		 * the {@link #value} attribute value. Possible values are: 
		 * <ul>
		 * <li><tt>"data"</tt>: This is default value for the attribute. It means that 
		 * the value specified by {@link #value} will be evaluated and passed to the 
		 * object's implementation as a string.</li>
		 * <li><tt>"ref"</tt>: The value specified by {@link #value} is a URI that 
		 * designates a resource where run-time values are stored. This allows support 
		 * tools to identify URIs given as parameters. The URI must be passed to the 
		 * object AS IS, that is, unresolved.</li>
		 * <li><tt>"object"</tt>: The value specified by {@link #value} is an identifier 
		 * that refers to an <tt>&lt;object&gt;</tt> declaration in the same document. 
		 * The identifier must be the value of the <tt>id</tt> attribute set for the 
		 * declared <tt>&lt;object&gt;</tt> element.</li>
		 * </ul></p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member valueType = new Value.String.Member(this, Members.valueType);
	}
	 ...
	 */
	public JsHTMLParamElement(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member valueType = new Value.String.Member(Members.valueType);
	 ...
	 */
	public final JsHTMLParamElement valueOf() {
		return new JsHTMLParamElement((JsObject)var().valueOf());
	}
}
