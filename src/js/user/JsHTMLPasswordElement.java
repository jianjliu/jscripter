 ...
 * {@link JsClient#HTMLPasswordElement} class.</p>
 ...
 * attribute of the value "password".</p>
 * <p>An input element of this class is intended for input of sensitive data, such as 
 * passwords. The input is masked, as the user types, to prevent bystanders from reading 
 * the input value over his/her shoulder. Note, however that the user's input is not 
 * encrypted in any way when the form is submitted, it is sent in clear text. As a 
 * security precaution, some browsers may prevent script code from reading the {@link JsHTMLInputElement#value} 
 * property. In other respects, an object of this class behaves like that of {@link JsHTMLTextFieldElement}. 
 * It triggers the {@link JsHTMLInputElement#onchange} event handler when the user changes 
 * the displayed value.</p>
 *  
 ...
 */
public class JsHTMLPasswordElement extends JsClient.HTMLPasswordElement.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLPasswordElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLPasswordElement with(ObjectLike o) {
			return new JsHTMLPasswordElement(super.with(o));
		}
	}
	 ...
	 */
	public JsHTMLPasswordElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsHTMLPasswordElement valueOf() {
		return new JsHTMLPasswordElement((JsObject)var().valueOf());
	}
}
