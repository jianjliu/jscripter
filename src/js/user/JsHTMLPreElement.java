 ...
 * {@link JsClient#HTMLPreElement} class.</p>
 * <p>This class represents a preformatted text 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;pre&gt;</tt> tag which tells browsers that the enclosed text is 
 * "preformatted".</p> 
 *
 ...
 */
public class JsHTMLPreElement extends JsClient.HTMLPreElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLPreElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLPreElement#width
		 * @see JsHTMLPreElement.Member#width
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLPreElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLPreElement with(ObjectLike o) {
			return new JsHTMLPreElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLPreElement} 
		 * object refers to an integer value that provides a hint to visual browsers 
		 * about the desired width of the formatted block. The browser can use this 
		 ...
		 * attribute is not widely supported currently.</p> 
		 * @since 1.0
	 ...
	 */
	public JsHTMLPreElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLPreElement valueOf() {
		return new JsHTMLPreElement((JsObject)var().valueOf());
	}
}
