 ...
 * {@link JsClient#HTMLQuoteElement} class.</p>
 * <p>This class represents a quoted text 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;q&gt;</tt> or <tt>&lt;blockquote&gt;</tt> tag.</p> 
 *
 ...
 */
public class JsHTMLQuoteElement extends JsClient.HTMLQuoteElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLQuoteElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLQuoteElement#cite
		 * @see JsHTMLQuoteElement.Member#cite
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLQuoteElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLQuoteElement with(ObjectLike o) {
			return new JsHTMLQuoteElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLQuoteElement} 
		 * object refers to a URI string that designates a source document or message. 
		 * This attribute is intended to give information about the source from which 
		 * the quotation was borrowed.</p> 
		 * @since 1.0
	 ...
	 */
	public JsHTMLQuoteElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLQuoteElement valueOf() {
		return new JsHTMLQuoteElement((JsObject)var().valueOf());
	}
}
