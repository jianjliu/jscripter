 ...
 * {@link JsClient#HTMLResetElement} class.</p>
 ...
 * attribute of the value "reset".</p>
 * <p>An input element of this class is like a push button of {@link JsHTMLButtonElement} 
 * class created with type "button" but has a more specialized purpose. When a reset 
 * button element is clicked, the values of all input elements in the {@link JsHTMLInputElement#form} 
 * that contains it are reset to their default values, specified by the HTML <tt>value</tt> 
 * attribute or the {@link JsHTMLInputElement#defaultValue} property.</p>
 * <p>The {@link JsHTMLInputElement#value} property specifies the text to appear in the 
 * button. A reset button triggers the {@link JsHTMLInputElement#onclick} handler 
 * before resetting the form, and this handler may cancel the reset by returning <tt>false</tt>. 
 * For other event cancellation methods see also the {@link JsHTMLFormElement#reset()} 
 * method and the {@link JsHTMLFormElement#onreset} event handler.</p>
 *  
 ...
 */
public class JsHTMLResetElement extends JsClient.HTMLResetElement.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLResetElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLResetElement with(ObjectLike o) {
			return new JsHTMLResetElement(super.with(o));
		}
	}
	 ...
	 */
	public JsHTMLResetElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsHTMLResetElement valueOf() {
		return new JsHTMLResetElement((JsObject)var().valueOf());
	}
}
