 ...
 * {@link JsClient#HTMLScriptElement} class.</p>
 * <p>This class represents a script 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;script&gt;</tt> tag which places a script within a document.</p>
 * <p>The <tt>&lt;script&gt;</tt> elements may appear any number of times in the <tt>&lt;head&gt;</tt> or 
 * <tt>&lt;body&gt;</tt> of an HTML document.</p> 
 * <p>The script may be defined within the contents of the <tt>&lt;script&gt;</tt> element 
 * or in an external file. If the {@link JsHTMLScriptElement#src} attribute is not set, 
 * browsers must interpret the contents of the element as the script. If the {@link JsHTMLScriptElement#src} 
 * has a URI value, browsers must ignore the element's contents and retrieve the script 
 * via the URI. Note that the {@link JsHTMLScriptElement#charset} attribute refers to 
 * the character encoding of the script designated by the {@link JsHTMLScriptElement#src} 
 * attribute; it does not concern the content of the <tt>&lt;script&gt;</tt> element.</p>
 * <p>Scripts are evaluated by script engines that must be known to a web browser.</p>
 ...
 */
public class JsHTMLScriptElement extends JsClient.HTMLScriptElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLScriptElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLScriptElement#text
		 * @see JsHTMLScriptElement.Member#text
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLScriptElement#htmlFor
		 * @see JsHTMLScriptElement.Member#htmlFor
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid htmlFor = id("htmlFor");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLScriptElement#event
		 * @see JsHTMLScriptElement.Member#event
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLScriptElement#charset
		 * @see JsHTMLScriptElement.Member#charset
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLScriptElement#defer
		 * @see JsHTMLScriptElement.Member#defer
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid defer   = id("defer"  );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLScriptElement#src
		 * @see JsHTMLScriptElement.Member#src
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLScriptElement#type
		 * @see JsHTMLScriptElement.Member#type
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLScriptElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLScriptElement with(ObjectLike o) {
			return new JsHTMLScriptElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLScriptElement} 
		 * object refers to a string specifying the script content of the element.</p> 
		 * @since 1.0
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLScriptElement} 
		 * object is reserved for future use by DOM2 HTML.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member htmlFor = new Value.String.Member(this, Members.htmlFor);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 ...
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member event   = new Value.String.Member(this, Members.event  );
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLScriptElement} 
		 * object refers to a URI string designating an external script.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLScriptElement} 
		 * object refers to a string specifying the content type of the script language.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLScriptElement} 
		 * object refers to a boolean value indicating that the browser can defer processing 
		 * of the script.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Boolean.Member defer = new Value.Boolean.Member(this, Members.defer);
	}
	 ...
	 */
	public JsHTMLScriptElement(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member htmlFor = new Value.String.Member(Members.htmlFor);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLScriptElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member event   = new Value.String.Member(Members.event  );
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLScriptElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Boolean.Member defer = new Value.Boolean.Member(Members.defer);
	 ...
	 */
	public final JsHTMLScriptElement valueOf() {
		return new JsHTMLScriptElement((JsObject)var().valueOf());
	}
}
