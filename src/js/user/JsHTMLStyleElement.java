 ...
 * {@link JsHTMLStyleElement} class.</p>
 * <p>This class represents a style sheet 
 * in an HTML document, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;style&gt;</tt>.</p>
 * <p>The <tt>&lt;style&gt;</tt> tag allows HTML authors to put style sheet rules in 
 * the head of the document. HTML permits any number of <tt>&lt;style&gt;</tt> elements 
 * in the <tt>&lt;head&gt;</tt> section of a document.</p>
 *
 ...
 */
public class JsHTMLStyleElement extends JsClient.HTMLStyleElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLStyleElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLStyleElement#disabled
		 * @see JsHTMLStyleElement.Member#disabled
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLStyleElement#media
		 * @see JsHTMLStyleElement.Member#media
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid media    = id("media"   );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLStyleElement#type
		 * @see JsHTMLStyleElement.Member#type
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLStyleElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLStyleElement with(ObjectLike o) {
			return new JsHTMLStyleElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLStyleElement} 
		 * object refers to a boolean value that enables or disables the style sheet.</p> 
		 * @since 1.0
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLStyleElement} 
		 * object refers to a string that specifies the intended destination medium for 
		 * style information. It may be a single media descriptor or a comma-separated 
		 * list. The default value for this attribute is "screen".</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member media = new Value.String.Member(this, Members.media);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLStyleElement} 
		 * object refers to a string that specifies the content type of the style sheet 
		 * language.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
	 ...
	 */
	public JsHTMLStyleElement(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member media = new Value.String.Member(Members.media);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLStyleElement} 
	 ...
	 */
	public final JsHTMLStyleElement valueOf() {
		return new JsHTMLStyleElement((JsObject)var().valueOf());
	}
}
