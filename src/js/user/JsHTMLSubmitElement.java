 ...
 * {@link JsClient#HTMLSubmitElement} class.</p>
 ...
 * attribute of the value "submit".</p>
 * <p>An input element of this class is a push button that submits the containing 
 * {@link JsHTMLInputElement#form} when clicked. The {@link JsHTMLInputElement#value} 
 * property specifies the text to appear in the button. The {@link JsHTMLInputElement#onclick} 
 * event handler is triggered before the {@link JsHTMLInputElement#form} is submitted, 
 * and a handler may cancel form submission by returning <tt>false</tt>. See also 
 * the {@link JsHTMLFormElement#submit()} method and the {@link JsHTMLFormElement#onsubmit} 
 * event handler.</p>
 *  
 ...
 */
public class JsHTMLSubmitElement extends JsClient.HTMLSubmitElement.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLSubmitElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLSubmitElement with(ObjectLike o) {
			return new JsHTMLSubmitElement(super.with(o));
		}
	}
	 ...
	 */
	public JsHTMLSubmitElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsHTMLSubmitElement valueOf() {
		return new JsHTMLSubmitElement((JsObject)var().valueOf());
	}
}
