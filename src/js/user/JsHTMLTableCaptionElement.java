 ...
 * {@link JsClient#HTMLTableCaptionElement} class.</p>
 * <p>This class represents a table caption 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;caption&gt;</tt> tag.</p>
 * <p>The <tt>&lt;caption&gt;</tt> element is only permitted immediately after the 
 * <tt>&lt;table&gt;</tt> start tag and it's text should describe the nature of the 
 * table. A <tt>&lt;table&gt;</tt> element may only contain one <tt>&lt;caption&gt;</tt> 
 * element.</p>
 *
 ...
 */
public class JsHTMLTableCaptionElement extends JsClient.HTMLTableCaptionElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLTableCaptionElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLTableCaptionElement#align
		 * @see JsHTMLTableCaptionElement.Member#align
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLTableCaptionElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLTableCaptionElement with(ObjectLike o) {
			return new JsHTMLTableCaptionElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLTableCaptionElement} 
	 ...
	 */
	public JsHTMLTableCaptionElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLTableCaptionElement valueOf() {
		return new JsHTMLTableCaptionElement((JsObject)var().valueOf());
	}
}
