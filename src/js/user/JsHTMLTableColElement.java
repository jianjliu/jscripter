 ...
 * {@link JsClient#HTMLTableColElement} class.</p>
 * <p>This class represents a table column 
 ...
 */
public class JsHTMLTableColElement extends JsClient.HTMLTableColElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLTableColElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLTableColElement#align
		 * @see JsHTMLTableColElement.Member#align
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableColElement#ch
		 * @see JsHTMLTableColElement.Member#ch
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableColElement#chOff
		 * @see JsHTMLTableColElement.Member#chOff
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableColElement#span
		 * @see JsHTMLTableColElement.Member#span
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid span   = id("span"  );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableColElement#vAlign
		 * @see JsHTMLTableColElement.Member#vAlign
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableColElement#width
		 * @see JsHTMLTableColElement.Member#width
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLTableColElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLTableColElement with(ObjectLike o) {
			return new JsHTMLTableColElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLTableColElement} 
		 * object refers to a string specifying the horizontal alignment of the elements 
		 * of the table column with respect to the surrounding context. Possible values 
		 * are:
		 * <ul>
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLTableColElement} 
		 * object refers to an integer value greater than 0 specifying the number of columns 
		 * spanned by this column. The default value for this attribute is 1, that is, 
		 * this column element refers to a single column. If the attribute is set to N 
		 * greater than 1, the current column element shares its attributes with the 
		 * next N-1 columns.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member span   = new Value.String.Member(this, Members.span  );
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 ...
		 * table column. Possible values are:
		 * <ul>
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLTableColElement} 
		 * object refers to a string specifying the width the current table column.</p>
		 * <p>This attribute is deprecated by HTML 4.01 and should be handled by style sheets.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
	 ...
	 */
	public JsHTMLTableColElement(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member span   = new Value.String.Member(Members.span  );
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLTableColElement} 
	 ...
	 */
	public final JsHTMLTableColElement valueOf() {
		return new JsHTMLTableColElement((JsObject)var().valueOf());
	}
}
