 ...
 * {@link JsClient#HTMLTableRowElement} class.</p>
 * <p>This class represents a table row 
 ...
 */
public class JsHTMLTableRowElement extends JsClient.HTMLTableRowElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLTableRowElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLTableRowElement#cells
		 * @see JsHTMLTableRowElement.Member#cells
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid cells           = id("cells"          );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableRowElement#rowIndex
		 * @see JsHTMLTableRowElement.Member#rowIndex
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid rowIndex        = id("rowIndex"       );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableRowElement#sectionRowIndex
		 * @see JsHTMLTableRowElement.Member#sectionRowIndex
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid sectionRowIndex = id("sectionRowIndex");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableRowElement#align
		 * @see JsHTMLTableRowElement.Member#align
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableRowElement#bgColor
		 * @see JsHTMLTableRowElement.Member#bgColor
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableRowElement#ch
		 * @see JsHTMLTableRowElement.Member#ch
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableRowElement#chOff
		 * @see JsHTMLTableRowElement.Member#chOff
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableRowElement#vAlign
		 * @see JsHTMLTableRowElement.Member#vAlign
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLTableRowElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLTableRowElement with(ObjectLike o) {
			return new JsHTMLTableRowElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLTableRowElement} 
		 * object is a read-only reference to a collection of {@link JsHTMLTableCellElement} 
		 * elements of the current table row.</p>
		 * @since 1.0
		 ...
		 */
		public final JsHTMLCollection.Member<JsHTMLTableCellElement> cells = new JsHTMLCollection.Member<JsHTMLTableCellElement>(this, Members.cells);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLTableRowElement} 
		 * object refers to an integer value specifying the index of this row in its table 
		 * in logical order and not in document order. It takes into account sections 
		 * within the table, placing <tt>&lt;thead&gt;</tt> rows first in the index, 
		 * followed by <tt>&lt;tbody&gt;</tt> rows, followed by <tt>&lt;tfoot&gt;</tt> 
		 * rows.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Number.Member rowIndex        = new Value.Number.Member(this, Members.rowIndex       );
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLTableRowElement} 
		 * object refers to an integer value specifying the index of this row in its table, 
		 * relative to the current section, starting from 0.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Number.Member sectionRowIndex = new Value.Number.Member(this, Members.sectionRowIndex);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 ...
		 * of the table row with respect to the surrounding context. Possible values 
		 * are:
		 * <ul>
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLTableRowElement} 
		 * object refers to a string specifying the background color for the table row.</p>
		 * <p>This attribute is deprecated by HTML 4.01 and should be handled by style sheets.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
	 ...
	 */
	public JsHTMLTableRowElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public static final JsHTMLCollection.Member<JsHTMLTableCellElement> cells = new JsHTMLCollection.Member<JsHTMLTableCellElement>(Members.cells);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLTableRowElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Number.Member rowIndex        = new Value.Number.Member(Members.rowIndex       );
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLTableRowElement} 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Number.Member sectionRowIndex = new Value.Number.Member(Members.sectionRowIndex);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsHTMLTableRowElement} 
	 ...
	 */
	public JsHTMLTableRowElement valueOf() {
		return new JsHTMLTableRowElement((JsObject)var().valueOf());
	}
	/**
	 * <p>Deletes the specified cell from the current row.</p>
	 * @param index The index of the cell to delete, starting from 0. If the index is 
	 ...
	 * JS Simulation.
	 * @since 1.0
	 * @see #deleteCell(NumberLike)
	 * @javascript Re-compilers must convert the instance invocation of this method directly
	 * into a JavaScript invocation on its current object instance without changing the 
	 * method name, but expanding variable arguments, if any, into comma-separated values. 
	 */
	public final void deleteCell(Number index) {
		call(deleteCell, index);
	}
	/**
	 * <p>Deletes the specified cell from the current row.</p>
	 * @param index The index of the cell to delete, starting from 0. If the index is 
	 ...
	 * JS Simulation.
	 * @since 1.0
	 * @see #deleteCell(Number)
	 * @javascript Re-compilers must convert the instance invocation of this method directly
	 * into a JavaScript invocation on its current object instance without changing the 
	 * method name, but expanding variable arguments, if any, into comma-separated values. 
	 */
	public final void deleteCell(NumberLike<?> index) {
		deleteCell(Js.valueOf(index));
	}
	/**
	 * <p>Insert an empty cell into this row.</p>
	 * <p>If <tt>index</tt> is -1 or equal to the number of cells, the new cell is 
	 * appended.</p>
	 * @param index The index of the place to insert the cell, starting from 0.
	 ...
	 * JS Simulation.
	 * @since 1.0
	 * @see #insertCell(NumberLike)
	 * @javascript Re-compilers must convert the instance invocation of this method directly
	 * into a JavaScript invocation on its current object instance without changing the 
	 * method name, but expanding variable arguments, if any, into comma-separated values. 
	 */
	public final JsHTMLTableCellElement insertCell(Number index) {
		return new JsHTMLTableCellElement(call(insertCell, index));
	}
	/**
	 * <p>Insert an empty cell into this row.</p>
	 * <p>If <tt>index</tt> is -1 or equal to the number of cells, the new cell is 
	 ...
	 * JS Simulation.
	 * @since 1.0
	 * @see #insertCell(Number)
	 * @javascript Re-compilers must convert the instance invocation of this method directly
	 * into a JavaScript invocation on its current object instance without changing the 
	 * method name, but expanding variable arguments, if any, into comma-separated values. 
	 */
	public final JsHTMLTableCellElement insertCell(NumberLike<?> index) {
		return insertCell(Js.valueOf(index));
	}
}
