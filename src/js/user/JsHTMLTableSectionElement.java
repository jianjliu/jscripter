 ...
 */
public class JsHTMLTableSectionElement extends JsClient.HTMLTableSectionElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLTableSectionElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLTableSectionElement#rows
		 * @see JsHTMLTableSectionElement.Member#rows
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableSectionElement#align
		 * @see JsHTMLTableSectionElement.Member#align
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableSectionElement#ch
		 * @see JsHTMLTableSectionElement.Member#ch
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableSectionElement#chOff
		 * @see JsHTMLTableSectionElement.Member#chOff
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLTableSectionElement#vAlign
		 * @see JsHTMLTableSectionElement.Member#vAlign
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLTableSectionElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLTableSectionElement with(ObjectLike o) {
			return new JsHTMLTableSectionElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLTableSectionElement} 
		 * object is a read-only reference to a collection of {@link JsHTMLTableRowElement} 
		 * elements of the current table section.</p>
		 * @since 1.0
		 ...
		 * of the table section with respect to the surrounding context. Possible values 
		 * are:
		 * <ul>
		 ...
		 * table section. Possible values are:
		 * <ul>
	 ...
	 */
	public JsHTMLTableSectionElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsHTMLTableSectionElement valueOf() {
		return new JsHTMLTableSectionElement((JsObject)var().valueOf());
	}
	/**
	 * <p>Deletes the specified row from the current table section.</p>
	 * @param index The index of the row to be deleted, or -1 to delete the last row. 
	 * This index starts from 0 and is relative only to the rows contained inside this 
	...
	/**
	 * <p>Insert a new row into the current table section.</p>
	 * <p>The new row is inserted immediately before the current <tt>index</tt>th row 
	 * in this table section. If <tt>index</tt> is -1 or equal to the number of rows 
	 * in the section, the new row is appended.</p>
	 * @param index The row number where to insert a new row. This index starts from 0 
	 * and is relative only to the rows contained inside this section, not all the rows 
	 * in the table.
