 ...
 * {@link JsClient#HTMLTextFieldElement} class.</p>
 ...
 * attribute of the value "text".</p>
 * <p>An input element of this class creates a single-line text input field. The HTML 
 * <tt>value</tt> attribute specifies the default text to appear in the field, and the 
 * {@link JsHTMLInputElement#value} property holds the currently displayed text. The {@link JsHTMLInputElement#onchange} 
 * event handler is triggered when the user edits the displayed text and then transfers 
 * input focus to some other element. Use {@link JsHTMLInputElement#size} to specify 
 * the width of the input field and {@link JsHTMLInputElement#maxLength} to specify 
 * the maximum number of characters that may be entered. When the {@link JsHTMLInputElement#form} 
 * contains only this single input element of type "text", pressing <tt>Enter</tt> 
 * submits the form.</p>
 *  
 ...
 */
public class JsHTMLTextFieldElement extends JsClient.HTMLTextFieldElement.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLTextFieldElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLTextFieldElement with(ObjectLike o) {
			return new JsHTMLTextFieldElement(super.with(o));
		}
	}
	 ...
	 */
	public JsHTMLTextFieldElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsHTMLTextFieldElement valueOf() {
		return new JsHTMLTextFieldElement((JsObject)var().valueOf());
	}
}
