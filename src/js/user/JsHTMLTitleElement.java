 ...
 * {@link JsClient#HTMLTitleElement} class.</p>
 * <p>This class represents a document title 
 * in an HTML page, or a {@link JsHTMLElement} object created with the HTML 
 * <tt>&lt;title&gt;</tt> tag.</p>
 * <p>Every HTML document must have a <tt>&lt;title&gt;</tt> element in the <tt>&lt;head&gt;</tt> 
 * section. For reasons of accessibility, web browsers must always make the content of 
 * the <tt>&lt;title&gt;</tt> element available to users including <tt>&lt;title&gt;</tt> 
 * elements that occur in frames. The mechanism for doing so depends on the browser spoken, 
 * e.g., as a caption of the displaying window.</p>
 *
 ...
 */
public class JsHTMLTitleElement extends JsClient.HTMLTitleElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLTitleElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLTitleElement#text
		 * @see JsHTMLTitleElement.Member#text
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLTitleElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLTitleElement with(ObjectLike o) {
			return new JsHTMLTitleElement(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsHTMLTitleElement} 
		 * object refers to a string that specifies the content text of the title.</p> 
		 * @since 1.0
	 ...
	 */
	public JsHTMLTitleElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLTitleElement valueOf() {
		return new JsHTMLTitleElement((JsObject)var().valueOf());
	}
}
