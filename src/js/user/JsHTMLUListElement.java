 ...
 */
public class JsHTMLUListElement extends JsClient.HTMLUListElement.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.HTMLUListElement.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsHTMLUListElement#compact
		 * @see JsHTMLUListElement.Member#compact
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsHTMLUListElement#type
		 * @see JsHTMLUListElement.Member#type
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.HTMLUListElement.Prototype.Member
	{
		/**
		 ...
		 */
		public JsHTMLUListElement with(ObjectLike o) {
			return new JsHTMLUListElement(super.with(o));
		}
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsHTMLUListElement} 
		 * object refers to a string specifying the type of the unordered list. Possible 
		 * values for the type attribute are "disc", "square", and "circle". The default 
		 * value depends on the level of nesting of the current list. These values are 
		 * case-insensitive. How each value is presented depends on the web browsers. 
		 * They should attempt to present a "disc" as a small filled-in circle, a "circle" 
		 * as a small circle outline, and a "square" as a small square outline.</p>
		 * <p>This attribute is deprecated by HTML 4.01 and should be handled by style sheets.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
	 ...
	 */
	public JsHTMLUListElement(JsObject var) {
		super(var);
	}
	 ...
	 */
	public final JsHTMLUListElement valueOf() {
		return new JsHTMLUListElement((JsObject)var().valueOf());
	}
}
