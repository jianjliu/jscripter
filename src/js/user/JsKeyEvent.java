 ...
 * {@link JsClient#KeyEvent} class.</p>
 * <p>An object of this class provides details about a keyboard event and is passed to 
 * event handlers for "keydown", "keypress", and "keyup" events.</p>
 * {@link JsClient#KeyEvent} 
 * object has not been standardized. The property members of this class describes the 
 * Firefox implementation. Many of these properties are also supported in the IE event 
 * model. See the IE-specific properties defined in {@link JsEvent}. Note that in 
 * addition to the property members in this class, {@link JsKeyEvent} objects also 
 * inherit the properties of {@link JsUIEvent} and {@link JsEvent}.</p>
 *
 ...
 */
public class JsKeyEvent extends JsClient.KeyEvent.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.KeyEvent.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsKeyEvent#altKey
		 * @see JsKeyEvent.Member#altKey
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsKeyEvent#charCode
		 * @see JsKeyEvent.Member#charCode
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsKeyEvent#ctrlKey
		 * @see JsKeyEvent.Member#ctrlKey
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsKeyEvent#keyCode
		 * @see JsKeyEvent.Member#keyCode
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsKeyEvent#shiftKey
		 * @see JsKeyEvent.Member#shiftKey
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.KeyEvent.Prototype.Member
	{
		/**
		 ...
		 */
		public JsKeyEvent with(ObjectLike o) {
			return new JsKeyEvent(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsKeyEvent} object 
		 ...
		 * is 0 for non-printing function keys and is not used for "keydown" and "keyup" 
		 ...
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsKeyEvent} object is 
		 * reference to an integer value representing virtual key code of the key that 
		 * was pressed. Key codes may be browser, OS, and keyboard dependent. Typically, 
		 * when a key displays a printing character on it, the virtual key code for that 
		 * key is the same as the encoding of the character. Key codes for non-printing 
		 * function keys may vary more.</p> 
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Number.Member keyCode  = new Value.Number.Member(this, Members.keyCode );
	}
	 ...
	 */
	public JsKeyEvent(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsKeyEvent valueOf() {
		return new JsKeyEvent((JsObject)var().valueOf());
	}
}
