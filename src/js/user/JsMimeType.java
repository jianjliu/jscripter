 ...
 * {@link JsClient#MimeType} class.</p>
 * <p>An object of {@link JsMimeType} represents a MIME type (i.e., a data format) 
 * supported by a web browser. The format may be supported directly by the browser, or 
 * through an external helper application or a plug-in for embedded data. {@link JsMimeType} 
 * objects are members of the {@link JsNavigator#mimeTypes} array of the {@link JsNavigator} 
 * object. The array may be indexed numerically or with the name of the desired MIME type 
 * which is the value of the {@link #type} property. In IE, the array is always empty, 
 * and there is no equivalent of this functionality.</p>
 *
 ...
 */
public class JsMimeType extends JsClient.MimeType.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.MimeType.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsMimeType#description
		 * @see JsMimeType.Member#description
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsMimeType#enabledPlugin
		 * @see JsMimeType.Member#enabledPlugin
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid enabledPlugin = id("enabledPlugin");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsMimeType#suffixes
		 * @see JsMimeType.Member#suffixes
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid suffixes      = id("suffixes"     );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsMimeType#type
		 * @see JsMimeType.Member#type
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.MimeType.Prototype.Member
	{
		/**
		 ...
		 */
		public JsMimeType with(ObjectLike o) {
			return new JsMimeType(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsMimeType} object 
		 * refers to a read-only string that provides a human-readable description 
		 * (in English) of the data type described by the MIME Type.</p> 
		 * @since 1.0
		 * @see JsMimeType#description
		 ...
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsMimeType} object is 
		 * a read-only reference to {@link JsPlugin} object that represents the installed 
		 * and enabled plug-in that handles the specified MIME type. If the MIME type is 
		 * not handled by any plug-ins (for example, if it's handled directly by the 
		 * browser), the value of this property is <tt>null</tt>. The property is also 
		 * <tt>null</tt> when a plug-in exists but has been disabled.</p> 
		 * @since 1.0
		 * @see JsMimeType#enabledPlugin
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final JsPlugin.Member enabledPlugin = new JsPlugin.Member(this, Members.enabledPlugin);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsMimeType} object 
		 * refers to a read-only string that contains a comma-separated list of filename 
		 * suffixes (not including the "." character) that are commonly used with files 
		 * of the specified MIME type. For example, the suffixes for the "text/html" 
		 * MIME type are "html, htm".</p> 
		 * @since 1.0
		 * @see JsMimeType#suffixes
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.String.Member suffixes    = new Value.String.Member(this, Members.suffixes     );
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsMimeType} object 
		 * refers to a read-only string that specifies the name of the MIME type. This 
		 * is a unique string such as "text/html" or "image/jpeg" that distinguishes 
		 * the MIME type from all others. It describes the general type of data and the 
		 * data format used. The value of the property can also be used as an index to 
		 * access the elements of the {@link JsNavigator#mimeTypes} array.</p> 
		 * @since 1.0
		 * @see JsMimeType#type
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
	 ...
	 */
	public JsMimeType(JsObject var) {
		super(var);
	}
	 ...
	 * identifier of the field name.
	 */
	public static final JsPlugin.Member enabledPlugin = new JsPlugin.Member(Members.enabledPlugin);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsMimeType} object 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.String.Member suffixes      = new Value.String.Member(Members.suffixes     );
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsMimeType} object 
	 ...
	 */
	public JsMimeType valueOf() {
		return new JsMimeType((JsObject)var().valueOf());
	}
}
