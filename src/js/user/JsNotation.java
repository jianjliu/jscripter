...
/**
 * <p>An <b>opaque</b> class representing JavaScript client-side <tt>Notation</tt> nodes.</p>
 * <p>This class represents a notation declared in the DTD. Programmers working exclusively 
 * with HTML documents never need to use this class. A notation either declares, by 
 * name, the format of an unparsed entity, or is used for formal declaration of 
 * processing instruction targets.</p>
 * <p>The inherited {@link JsNode#nodeName} attribute is set to the declared name of 
 * the notation.</p>
 * <p>The DOM Level 1 does not support editing {@link JsNotation} nodes. They are 
 * therefore read-only.</p>
 * <p>A {@link JsNotation} node does not have any parent, that is, {@link JsNode#parentNode} 
 * property for a {@link JsNotation} node is always <tt>null</tt>.</p>
 * <p>Note that main-stream web browsers do not support the <tt>Notation</tt> interface 
...
public class JsNotation extends JsNode
{
	...
	protected static abstract class Members extends JsClient.Node.Prototype.Members
	{
		 ...
		 * @since 1.0
		 * @see JsNotation#publicId
		 * @see JsNotation.Member#publicId
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsNotation#systemId
		 * @see JsNotation.Member#systemId
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	...
	public static class Member extends JsClient.Node.Prototype.Member
	{
		 ...
		 */
		public JsNotation with(ObjectLike o) {
			return new JsNotation(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsNotation} object 
		 * refers to a read-only string specifying the public identifier of this 
		 * notation. If the public identifier was not specified, this is <tt>null</tt>.</p>
		 * @since 1.0
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsNotation} object 
		 * refers to a read-only string specifying the system identifier of this 
		 * notation. If the system identifier was not specified, this is <tt>null</tt>.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
	 ...
	 */
	public JsNotation(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsNotation valueOf() {
		return new JsNotation((JsObject)var().valueOf());
	}
}
