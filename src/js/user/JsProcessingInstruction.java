 ...
 * {@link JsClient#ProcessingInstruction} class.</p>
 * <p>This class is infrequently used and represents a processing instruction (or PI) 
 * in an XML document. Programmers working with HTML documents will never encounter a 
 * {@link JsProcessingInstruction} node</p>
 *
 ...
 */
public class JsProcessingInstruction extends JsClient.ProcessingInstruction.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.ProcessingInstruction.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsProcessingInstruction#data
		 * @see JsProcessingInstruction.Member#data
		 ...
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsProcessingInstruction#target
		 * @see JsProcessingInstruction.Member#target
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.ProcessingInstruction.Prototype.Member
	{
		/**
		 ...
		 */
		public JsProcessingInstruction with(ObjectLike o) {
			return new JsProcessingInstruction(super.with(o));
		}
		 ...
		 * @since 1.0
		 * <p>The property, identified by this member, of a {@link JsProcessingInstruction} object 
		 * refers to the content of the processing instruction , that is, the first non-space 
		 * character after the target up to but not including the closing ?&gt;.</p> 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsProcessingInstruction} object 
		 * refers to a read-only string that specifies the target of the processing 
		 * instruction. This is the first identifier that follows the opening &lt;? and 
		 * specifies the "processor" for which the processing instruction is intended.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
	 ...
	 */
	public JsProcessingInstruction(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsProcessingInstruction valueOf() {
		return new JsProcessingInstruction((JsObject)var().valueOf());
	}
}
