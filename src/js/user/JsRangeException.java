 ...
 * {@link JsClient#RangeException} class.</p>
 * <p>An object of this class is thrown by certain methods of the {@link JsRange} class 
 * to signal a problem of some sort. Note that most exceptions thrown by {@link JsRange} 
 * methods are {@link JsDOMException} objects. A {@link JsRangeException} object is 
 * generated only when none of the existing {@link JsDOMException} error constants is 
 * appropriate to describe the exception.</p>
 *
 ...
 */
public class JsRangeException extends JsClient.RangeException.Prototype
{
	/**
	 * A legal value for the {@link #code} property of a {@link JsRangeException} object 
	 * indicating the boundary points of a range are not legal for the requested 
	 * operation.
	 * @since 1.0
	 * @see js.dom.DOM2Range.RangeException#BAD_BOUNDARYPOINTS_ERR
	 * @see js.dom.DOM2Range.RangeException.Member#BAD_BOUNDARYPOINTS_ERR
	 */
	public static final int BAD_BOUNDARYPOINTS_ERR = 1;
	/**
	 * A legal value for the {@link #code} property of a {@link JsRangeException} object 
	 * indicating an attempt was made to set the container node of a range boundary 
	 * point to an invalid node or a node with an invalid ancestor.
	 * @since 1.0
	 * @see js.dom.DOM2Range.RangeException#INVALID_NODE_TYPE_ERR
	 * @see js.dom.DOM2Range.RangeException.Member#INVALID_NODE_TYPE_ERR
	 */
	 ...
	 */
	protected static abstract class Members extends JsClient.RangeException.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsRangeException#code
		 * @see JsRangeException.Member#code
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.RangeException.Prototype.Member
	{
		/**
		 ...
		 */
		public JsRangeException with(ObjectLike o) {
			return new JsRangeException(super.with(o));
		}
		 ...
		 * <p>The property, identified by this member, of a {@link JsRangeException} 
		 ...
		 * defined by the static constants of {@link JsRangeException} class.</p>
		 * @since 1.0
	 ...
	 */
	public JsRangeException(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsRangeException valueOf() {
		return new JsRangeException((JsObject)var().valueOf());
	}
}
