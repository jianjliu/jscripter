 ...
 * {@link JsClient#Screen} class.</p>
 * {@link JsWindow#screen} property of every {@link JsWindow} object refers to a {@link JsScreen} 
 * object. The properties of this global object contain information about the screen on 
 * which the browser is displayed. This information can be used to optimize the output 
 * for the user's display capabilities. A program can choose between large and small 
 * images based on the display size and between 8-bit and 16-bit color images based on 
 * the screen's color depth. It can also use the information about the size of the 
 * screen to center new browser windows on the screen.</p>
 *
 ...
 */
public class JsScreen extends JsClient.Screen.Prototype
{
	/**
	 ...
	 */
	protected static abstract class Members extends JsClient.Screen.Prototype.Members
	{
		/**
		 ...
		 * @since 1.0
		 * @see JsScreen#availHeight
		 * @see JsScreen.Member#availHeight
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid availHeight = id("availHeight");
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsScreen#availWidth
		 * @see JsScreen.Member#availWidth
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid availWidth  = id("availWidth" );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsScreen#colorDepth
		 * @see JsScreen.Member#colorDepth
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
		public final static Mid colorDepth  = id("colorDepth" );
		/**
		 * <p>An <b>internal</b> static field defining a member ID of the field name and
		 * used internally to define a member of the same name.</p>
		 * @since 1.0
		 * @see JsScreen#height
		 * @see JsScreen.Member#height
		 * @javascript Re-compilers must report error on accessing an <b>internal</b> field.
		 */
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.Screen.Prototype.Member
	{
		/**
		 ...
		 */
		public JsScreen with(ObjectLike o) {
			return new JsScreen(super.with(o));
		}
		/**
		 ...
		 * <p>The property, identified by this member, of a {@link JsScreen} object 
		 * refers to read-only number specifying the available height, in pixels, of the 
		 * screen on which the web browser is displayed. On operating systems such as 
		 * Windows, this available height does not include vertical space allocated to 
		 * semipermanent features, such as the task bar at the bottom of the screen.</p>
		 * @since 1.0
		 ...
		 */
		public final Value.Number.Member availHeight = new Value.Number.Member(this, Members.availHeight);
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsScreen} object 
		 * refers to read-only number specifying the available width, in pixels, of the 
		 * screen on which the web browser is displayed. On operating systems such as 
		 * Windows, this available width does not include horizontal space allocated to 
		 * semipermanent features, such as application shortcut bars.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Number.Member availWidth  = new Value.Number.Member(this, Members.availWidth );
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsScreen} object 
		 * refers to read-only number specifying the color depth of the screen in bits 
		 * per pixel.</p>
		 * @since 1.0
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 * qualifying member with a dot in between.
		 */
		public final Value.Number.Member colorDepth  = new Value.Number.Member(this, Members.colorDepth );
		/**
		 * <p>An <b>opaque</b> instance field defining a sub-member that is named by the
		 * name of this field, qualified by the current member instance of the field, and 
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsScreen} object 
		 * refers to read-only number specifying the total height, in pixels, of the 
		 * screen on which the web browser is displayed.</p>
		 * @since 1.0
		 * @see #availHeight
		 * @javascript Re-compilers must resolve the member of this instance field to the
		 * identifier of the field name appending to the identifier resolved from its 
		 ...
		 * to access the property of the name on an object.</p>
		 * <p>The property, identified by this member, of a {@link JsScreen} object 
		 * refers to read-only number specifying the total width, in pixels, of the 
		 * screen on which the web browser is displayed.</p>
		 * @since 1.0
		 * @see #availWidth
		 * @javascript Re-compilers must resolve the member of this instance field to the
	 ...
	 */
	public static final Value.Number.Member availHeight = new Value.Number.Member(Members.availHeight);
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsScreen} object 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Number.Member availWidth  = new Value.Number.Member(Members.availWidth );
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsScreen} object 
	 ...
	 * identifier of the field name.
	 */
	public static final Value.Number.Member colorDepth  = new Value.Number.Member(Members.colorDepth );
	/**
	 * <p>An <b>opaque</b> static field defining a member that is named by the field name
	 * without a qualifying member and to access the property of the name on an object.</p>
	 * <p>The property, identified by this member, of a {@link JsScreen} object 
	 ...
	 */
	public JsScreen valueOf() {
		return new JsScreen((JsObject)var().valueOf());
	}
}
