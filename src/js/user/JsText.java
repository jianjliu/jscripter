 ...
 * {@link JsClient#Text} class.</p>
 * <p>A {@link JsText} node represents a run of plain text in an HTML or XML document. 
 * Plain text appears within HTML and XML elements and attributes, and {@link JsText} 
 * nodes typically appear as children of {@link JsElement} and {@link JsAttr} nodes. 
 * {@link JsText} nodes inherit from {@link JsCharacterData}, and the textual content of 
 * a {@link JsText} node is available through the {@link JsCharacterData#data} property 
 * inherited from {@link JsCharacterData} or through the {@link JsNode#nodeValue} 
 * property inherited from {@link JsNode}. {@link JsText} nodes may be manipulated using 
 * any of the methods inherited from {@link JsCharacterData} or with the {@link #splitText(Number)} 
 * method defined by {@link JsText} itself. Create a new {@link JsText} node with {@link JsDocument#createTextNode(String)}. 
 * {@link JsText} nodes never have children.</p>
 * <p>See {@link JsNode#normalize()} for a way to remove empty {@link JsText} nodes and 
 * merge adjacent {@link JsText} nodes from a subtree of a document.</p>
 *
 ...
 */
public class JsText extends JsClient.Text.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.Text.Prototype.Member
	{
		/**
		 ...
		 */
		public JsText with(ObjectLike o) {
			return new JsText(super.with(o));
		}
	}
	 ...
	 */
	public JsText valueOf() {
		return new JsText((JsObject)var().valueOf());
	}

	/**
	 * <p>Splits this {@link JsText} node into two at the specified character position 
	 * and returns the new {@link JsText} node.</p>
	 * <p>This method splits a {@link JsText} node in two at the specified <tt>offset</tt>. 
	 * The original {@link JsText} node is modified so that it contains all text content 
	 * up to, but not including, the character at position <tt>offset</tt>. A new {@link JsText} 
	 * node is created to contain all the characters from and including the position <tt>offset</tt> 
	 * to the end of the string. The new {@link JsText} node is the return value of the 
	 * method. Additionally, if the original {@link JsText} node has a {@link JsNode#parentNode}, 
	 * the new node is inserted into this parent node immediately after the original node.</p>
	 * <p>{@link JsCDATASection} inherits from {@link JsText}. The newly created node of 
	 * {@link JsCDATASection#splitText(Number)} is a {@link JsCDATASection} node rather 
	 * than a {@link JsText} node.</p>
	 * @param offset The character position at which to split the {@link JsText} node.
	 * @return The {@link JsText} node that was split from this node.
	 ...
	 * if <tt>offset</tt> is negative or is greater than the length of the {@link JsText} or 
	 * {@link JsComment} node. 
	 ...
	 * method name, but expanding variable arguments, if any, into comma-separated values. 
	 */
	public JsText splitText(Number offset) {
		return call(splitText, offset);
	}
	/**
	 * <p>Splits this {@link JsText} node into two at the specified character position 
	 * and returns the new {@link JsText} node.</p>
	 ...
	 * the new node is inserted into this parent node immediately after the original node.</p>
	 * <p>{@link JsCDATASection} inherits from {@link JsText}. The newly created node of 
	 * {@link JsCDATASection#splitText(NumberLike)} is a {@link JsCDATASection} node rather 
	 * than a {@link JsText} node.</p>
	 * @param offset The character position at which to split the {@link JsText} node.
	 * @return The {@link JsText} node that was split from this node.
	 * @throws RuntimeException JavaScript throws a a {@link JsDOMException} object with 
	 ...
	 * method name, but expanding variable arguments, if any, into comma-separated values. 
	 */
	public JsText splitText(NumberLike<?> offset) {
