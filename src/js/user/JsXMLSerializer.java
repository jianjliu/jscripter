 ...
 * {@link JsClient#XMLSerializer} class.</p>
 * <p>This class enables you to convert or serialize an XML {@link JsDocument} or {@link JsNode} 
 * object to a string of unparsed XML mark-up. To use this class, instantiate an object 
 * {@link JsClient#XMLSerializer}, 
 * and then call its {@link #serializeToString(JsNode)} method:
 * <pre>String s = Js.win().XMLSerializer.create().serializeToString(e);</pre>
 * </p>
 * <p>IE does not implement this class. Instead, it makes XML text available through the 
 * {@link JsNode#xml} property of {@link JsNode} objects.</p>
 *
 ...
 */
public class JsXMLSerializer extends JsClient.XMLSerializer.Prototype
{
	/**
	 ...
	 * circumstances.
	 */
	public static class Member extends JsClient.XMLSerializer.Prototype.Member
	{
		/**
		 ...
		 */
		public JsXMLSerializer with(ObjectLike o) {
			return new JsXMLSerializer(super.with(o));
		}
		/**
	 ...
	 */
	public JsXMLSerializer(JsObject var) {
		super(var);
	}
	 ...
	 */
	public JsXMLSerializer valueOf() {
		return new JsXMLSerializer((JsObject)var().valueOf());
	}
	/**
	 * <p>Performs the actual serialization on the {@link JsDocument} object or 
	 * {@link JsElement} node.</p>
	 * @param node The XML node to be serialized. This may be a {@link JsDocument} 
	 * object or any {@link JsElement} node within the document.
	 * @return A string of XML mark-up that represents the serialized form of the 
	 * specified <tt>node</tt> and all its descendants.
	 * @since 1.0
	 * @javascript Re-compilers must convert the instance invocation of this method directly
	 * into a JavaScript invocation on its current object instance without changing the 
	 * method name, but expanding variable arguments, if any, into comma-separated values. 
	 */
	public String serializeToString(JsNode node) {
		return call(serializeToString, node);
	}
}
