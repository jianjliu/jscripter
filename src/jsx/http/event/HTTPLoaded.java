 ...
 * when the state of its HTTP transmission has been completed.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class HTTPLoaded extends HTTPState<OnHTTPLoaded>
{
	/**
	 ...
	 */
	@Override
	protected final void execute(OnHTTPLoaded on) {
		on.onEvent(this);
	}
}
