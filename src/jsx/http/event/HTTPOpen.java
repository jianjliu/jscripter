 ...
 * when the session of its HTTP transmission has just been opened.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class HTTPOpen extends HTTPState<OnHTTPOpen>
{
	/**
	 ...
	 */
	@Override
	protected final void execute(OnHTTPOpen on) {
		on.onEvent(this);
	}
}
