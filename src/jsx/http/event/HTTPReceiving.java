 ...
 * when it has just started to be receiving HTTP data.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class HTTPReceiving extends HTTPState<OnHTTPReceiving>
{
	/**
	 ...
	 */
	@Override
	protected final void execute(OnHTTPReceiving on) {
		on.onEvent(this);
	}
}
