 ...
 * when it has just sent a request for receiving data to an opened HTTP session.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class HTTPSent extends HTTPState<OnHTTPSent>
{
	/**
	 ...
	 */
	@Override
	protected final void execute(OnHTTPSent on) {
		on.onEvent(this);
	}
}
