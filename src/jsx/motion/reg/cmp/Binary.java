...
/**
 * <p>An abstract class to define a composite regular function with two existing ones.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public abstract class Binary extends Composite
{
	/**
	 ...
	 * @since 1.0
	 */
	protected Binary(final Regular r1, final Regular r2) {
		super(new Regular() {
			@Override
			protected double function(double x) {
				return x < 0.5 ? call(r1, x) : call(r2, x);
			}
		});
	}
}
