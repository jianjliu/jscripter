...
/**
 * <p>Defines a composite regular function with an existing regular function in charge of 
 * both the 1st and the 2nd halves of the domain.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class Both extends Joint
{
	/**
