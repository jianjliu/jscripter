 ...
 * the mouse moves over a related widget while dragging the source widget.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class DragOver extends Widget.Event<OnDragOver>
{
	/**
	 ...
	 * @since 1.0
	 */
	public DragOver(Component target) {
		super(target);
	}
	 ...
	 */
	@Override
	protected final void execute(OnDragOver on) {
		on.onEvent(this);
	}
}
