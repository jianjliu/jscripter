 ...
 * the widget is being dragged.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class DragStart extends Position<OnDragStart>
{
	/**
	 ...
	 * @param target The component where the mouse has been pressing. It may be different 
	 ...
	 * @since 1.0
	 */
	public DragStart(Component target, Number x, Number y) {
		super(target, x, y);
	}
	 ...
	 */
	@Override
	protected final void execute(OnDragStart on) {
		on.onEvent(this);
	}
}
