 ...
 * the browser mouse double-click event occurs on the element wrapped by the widget.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class DblClick extends Widget.Event<OnDblClick>
{
	/**
	 ...
	 * @param target The component where the mouse is clicked. It may be different from 
	 * the source widget which has is firing the event.
	 * @since 1.0
	 */
	public DblClick(Component target) {
		super(target);
	}
	 ...
	 */
	@Override
	protected final void execute(OnDblClick on) {
		on.onEvent(this);
	}
}
