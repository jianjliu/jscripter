 ...
 * the browser mouse down event occurs on the element wrapped by the widget.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class MouseDown extends Widget.Event<OnMouseDown>
{
	/**
	 ...
	 * @param target The component where the mouse has just been press down. It may be 
	 * different from the source widget which is firing the event.
	 * @since 1.0
	 */
	public MouseDown(Component target) {
		super(target);
	}
	 ...
	 */
	@Override
	protected final void execute(OnMouseDown on) {
		on.onEvent(this);
	}
}
