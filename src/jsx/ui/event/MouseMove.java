 ...
 * the browser mouse move event occurs on the element wrapped by the widget.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class MouseMove extends Position<OnMouseMove>
{
	/**
	 ...
	 * @since 1.0
	 */
	public MouseMove(Component target, Number x, Number y) {
		super(target, x, y);
	 ...
	 */
	@Override
	protected final void execute(OnMouseMove on) {
		on.onEvent(this);
	}
}
