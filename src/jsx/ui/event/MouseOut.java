 ...
 * the browser mouse out event occurs on the element wrapped by the widget.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class MouseOut extends Widget.Event<OnMouseOut>
{
	/**
	 ...
	 * @since 1.0
	 */
	public MouseOut(Component target) {
		super(target);
	}
	 ...
	 */
	@Override
	protected final void execute(OnMouseOut on) {
		on.onEvent(this);
	}
}
