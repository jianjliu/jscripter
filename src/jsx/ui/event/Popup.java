 ...
 * the element wrapped by the widget pops up on the display stack.</p>
 * <p>Note that, events of this type bubbles by default.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class Popup extends Widget.Event<OnPopup>
{
	/**
	 * <p>Constructs an event of this type.</p>
	 * <p>This constructor simply invokes the default constructor of the superclass.</p>
	 * <p>Note that, this constructor does not change the configurable property {@link jsx.Source.Event#UPDATE}
	 * but it sets the configurable property {@link jsx.Source.Event#BUBBLE} to <tt>true</tt>.</p>
	 * @since 1.0
	 */
	public Popup() {
		ini(this).var(BUBBLE, true);
	}
	 ...
	 */
	@Override
	protected final void execute(OnPopup on) {
		on.onEvent(this);
	}
}
