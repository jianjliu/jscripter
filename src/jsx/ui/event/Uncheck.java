 ...
 * the browser mouse click event occurs on the element wrapped by the widget.</p>
 * 
 * @author <a href="mailto:jianjunliu@126.com">J.J.Liu (Jianjun Liu)</a> at <a href="http://www.jscripter.org" target="_blank">http://www.jscripter.org</a>
 */
public final class Uncheck extends Widget.Event<OnUncheck>
{
	/**
	 ...
	 * @since 1.0
	 */
	public Uncheck(Component target) {
		super(target);
	}
	 ...
	 */
	@Override
	protected final void execute(OnUncheck on) {
		on.onEvent(this);
	}
}
