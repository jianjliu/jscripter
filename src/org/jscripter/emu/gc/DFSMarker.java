...
/**
 * <p>An <tt>internal</tt> class for DOM-enabled depth-first-search garbage markers emulating 
 ...
 */
public final class DFSMarker extends DFS
{
	/**
	...
	public void visit(ObjectLike o) {
		if (ObjectLikes.get(o, TIMES) < times()) {
			o.var(TIMES, times());
			o.var(COUNT, 1);
			ObjectLikes.delete(o, LIVES);
			traverse(o);
		} else {
