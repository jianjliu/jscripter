...
/**
 * <p>An <tt>internal</tt> class for DOM-enabled depth-first-search garbage sweepers emulating 
 ...
 */
public final class DFSSweeper extends DFS
{
	/**
	...
	public final void visit(ObjectLike o) {
		if (ObjectLikes.get(o, LIVES) < 1) {
			ObjectLikes.delete(o, REFS);
			traverse(o);
			new DFSCollector().visit(o);
		}
	}
}
