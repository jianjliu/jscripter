...
/**
 * <p>An <b>internal</b> interface represents a source or destination of data that can be closed.</p> 
 * <p>This class or interface is only used internally by JS re-compiler implementations.</p>
...
{
	/**
	 * <p>Internally closes this stream and releases any system resources associated with it.</p>
	 * <p>If the stream is already closed then invoking this method has no effect.</p> 
	 * @throws java.lang.IOException If an I/O error occurs
	 * @since 1.0
