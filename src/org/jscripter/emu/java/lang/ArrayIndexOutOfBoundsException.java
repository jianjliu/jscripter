...
/**
 * <p>An <b>internal</b> class of an exception thrown to indicate that an array has
 * been accessed with an illegal index, emulating a standard <tt>java.lang</tt>
...
public class ArrayIndexOutOfBoundsException extends IndexOutOfBoundsException
{
	...
	public ArrayIndexOutOfBoundsException(int index) {
		super(new Value.String("Array").add(" ").add("index").add(" ")
				.add(index).add(" ").add("out").add(" ").add("of").add(" ")
				.add("range").var());
	}
}
