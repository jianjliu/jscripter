...
/**
 * <p>An <b>internal</b> class of an exception thrown to indicate that an attempt has been made to store the wrong type 
 * of object into an array of objects, emulating a standard <tt>java.lang</tt> interface or class with 
...
public class ArrayStoreException extends RuntimeException
{
	 ...
	 * @javascript Re-compilers must report error on end-users directly using this constructor.
	 */
	public ArrayStoreException(java.lang.String message) {
		super(message);
	}
}
