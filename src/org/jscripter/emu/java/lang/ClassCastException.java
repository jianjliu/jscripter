...
/**
 * <p>An <b>internal</b> class of an exception thrown to indicate that an attempt has
 * been made to cast an object to a subclass of which it is not an instance, emulating a standard 
...
public class ClassCastException extends RuntimeException
{
	 ...
	 * @javascript Re-compilers must report error on end-users directly using this constructor.
	 */
	public ClassCastException(java.lang.String message) {
		super(message);
	}
}
