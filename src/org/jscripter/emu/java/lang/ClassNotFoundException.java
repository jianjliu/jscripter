...
/**
 * <p>An <b>internal</b> class of an exception thrown when an application tries to
 * load in a class but no definition for the class with the specified name could
 * be found, emulating a standard <tt>java.lang</tt> interface or class with the
 * same simple name as this one.</p>
...
public class ClassNotFoundException extends Exception
{
	 ...
	 * @javascript Re-compilers must report error on end-users directly using this constructor.
	 */
	public ClassNotFoundException(java.lang.String message) {
		super(message);
	}

	/**
	 * <p>Internally constructs an exception of this type with detail message andcause.</p>
	 * 
	 * @param message The detail message.
	 ...
	 * @javascript Re-compilers must report error on end-users directly using this constructor.
	 */
	public ClassNotFoundException(java.lang.String message, Throwable cause) {
		super(message, cause);
	}
}
