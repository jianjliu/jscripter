...
/**
 * <p>An <b>internal</b> class of an exception thrown to indicate the
 * <tt>clone()</tt> method in class {@link Object} has been called to clone an
 * object, but that the object's class does not implement the {@link Cloneable}
 * interface, emulating a standard <tt>java.lang</tt> interface or class with
...
public class CloneNotSupportedException extends Exception
{
	 ...
	 * @javascript Re-compilers must report error on end-users directly using this constructor.
	 */
	public CloneNotSupportedException(java.lang.String message) {
		super(message);
	}
}
