...
/**
 * <p><b>Internally</b> indicates serious problems that a reasonable application should not 
 * try to catch, emulating a standard <tt>java.lang</tt> interface or class with the same 
 * simple name as this one.</p>
...
public class Error extends Throwable
{
	...
	/**
	 * <p>Internally constructs an error of this type with detail message.</p>
	...
	/**
	 * <p>Internally constructs an error of this type with detail message and cause.</p>
	 * @param message The detail message.
	 * @param cause The cause.
	 * @since 1.0
	 * @javascript Re-compilers must report error on end-users directly using this constructor.
	 */
	public Error(java.lang.String message, Throwable cause) {
		super(message, cause);
	}

	/**
	 * <p>Internally constructs an error of this type with cause.</p>
	 * @param cause The cause.
	 * @since 1.0
	 * @javascript Re-compilers must report error on end-users directly using this constructor.
	 */
