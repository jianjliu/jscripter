...
/**
 * <p>An <b>internal</b> {@link Throwable} that indicates conditions that a reasonable 
 * application might want to catch, emulating a standard <tt>java.lang</tt> interface or class 
 * with the same simple name as this one.</p>
