...
/**
 * <p>An <b>internal</b> class of an exception, emulating a standard <tt>java.lang</tt> interface 
 * or class with the same simple name as this one, thrown when an application tries to create 
 * an instance of a class using the {@link Class#newInstance()} method in class {@link Class}, 
 * but the specified class object cannot be instantiated.</p>
