...
/**
 * <p><b>Internally</b> allows an object that implements it to be the target of the "foreach" 
 * statement, emulating a standard <tt>java.lang</tt> interface or class with the same simple 
 * name as this one.</p>
