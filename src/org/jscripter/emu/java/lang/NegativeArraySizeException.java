...
/**
 * <p>An <b>internal</b> class of an exception thrown if an application tries to create an array 
 * with negative size, emulating a standard <tt>java.lang</tt> interface or class with the same 
