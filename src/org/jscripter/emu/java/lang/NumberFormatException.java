...
/**
 * <p>An <b>internal</b> class of an exception thrown to indicate that the
 * application has attempted to convert a string to one of the numeric types,
 * but that the string does not have the appropriate format, emulating a
...
public class NumberFormatException extends IllegalArgumentException
{
	 ...
	 * @javascript Re-compilers must report error on end-users directly using this constructor.
	 */
	public NumberFormatException(java.lang.String message) {
		super(message);
	}
}
