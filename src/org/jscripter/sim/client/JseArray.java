...
final class JseArray extends JsArray implements Unwrappable<JseObject>, Live
{
	public JseArray(JseObject var) {
		super((Object)var);
	}

	@Override
	public final JseArray var() {
		return this;
	}
