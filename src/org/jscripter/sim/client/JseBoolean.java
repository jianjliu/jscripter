...
final class JseBoolean extends JsBoolean implements Unwrappable<JseObject>, Live
{
	public JseBoolean(JseObject var) {
		super((Object)var);
	}

	@Override
	public final Boolean valueOf() {
		return (Boolean)unwrap().valueOf();
	}
	@Override
	public final JseBoolean var() {
		return this;
	}
