...
/**
 * <p>An <b>internal</b> class for JS Core Simulation.</p>
 ...
 */
public class Core extends Simul
{
	private static Core singleton;

	/**
	 * <p>Internally determines whether a JS Core Simulation is running.</p>
	...
	/**
	 * <p>Internally gets a JS Core Simulation.</p>
	 * @return A Js Core Simulation.
	 * @since 1.0
	 * 
	 * @javascript Re-compilers must report error on the invocation to an <b>internal</b> constructor. 
	 */
	public final static synchronized Core get() {
		if (singleton == null) {
			singleton = new Core();
		}
		return singleton;
	...
	/**
	 * <p>Internally constructs a JS Core Simulation.</p>
	 * @since 1.0
	 * 
	 * @javascript Re-compilers must report error on the invocation to an <b>internal</b> constructor. 
	 */
	 ...
	 */
	@Override
	protected final <T extends Number> NumberLike<T> numberLike(T n) {
		return super.numberLike(n);
	}
	 ...
	 */
	@Override
	protected final StringLike stringLike(String s) {
		return super.stringLike(s);
	}
	...
	@Override
	protected JsWin win() {
		throw new UnsupportedOperationException("Core only!");
	}

	private JscGlobal g = null;
	...
	protected JsArray toJsArray(JsObject o) {
		Unwrappable<JscObject> u = o == null ? null : (Unwrappable<JscObject>)o.var();
		return u == null ? null : new JscArray(u.unwrap());
	}
	...
	protected JsBoolean toJsBoolean(JsObject o) {
		Unwrappable<JscObject> u = o == null ? null : (Unwrappable<JscObject>)o.var();
		return u == null ? null : new JscBoolean(u.unwrap());
	}
	...
	protected JsDate toJsDate(JsObject o) {
		Unwrappable<JscObject> u = o == null ? null : (Unwrappable<JscObject>)o.var();
		return u == null ? null : new JscDate(u.unwrap());
	}
	...
	protected <T> JsFunction<T> toJsFunction(JsObject o) {
		Unwrappable<JscObject> u = o == null ? null : (Unwrappable<JscObject>)o.var();
		return u == null ? null : new JscFunction<T>(u.unwrap());
	}
	...
	protected JsNumber toJsNumber(JsObject o) {
		Unwrappable<JscObject> u = o == null ? null : (Unwrappable<JscObject>)o.var();
		return u == null ? null : new JscNumber(u.unwrap());
	}
	...
	protected JsRegExp toJsRegExp(JsObject o) {
		Unwrappable<JscObject> u = o == null ? null : (Unwrappable<JscObject>)o.var();
		return u == null ? null : new JscRegExp(u.unwrap());
	}
	...
	protected JsString toJsString(JsObject o) {
		Unwrappable<JscObject> u = o == null ? null : (Unwrappable<JscObject>)o.var();
		return u == null ? null : new JscString(u.unwrap());
	}
	...
	protected Vars<?> vars(Object args) {
		...
		if (args instanceof ArrayLike<?>) {
			ArrayLike<?> a = (ArrayLike<?>)args;
	...
	protected ArrayLike<String> keys(JsObject o) {
		...
		Iterator<Mid> it = ((JscObject)((Unwrappable<?>)o.var()).unwrap()).iterator();
		while (it.hasNext()) {
	...
	protected <T> JsFunction<T> function(Vars<String> args) {
		...
		if (a.length() < 1) {
			return new Function<T>() {
				@Override
				protected T function(Object jsthis, Call<T> callee) {
					return null;
				}
			}.var();
		}
	...
	protected final boolean eqs(Object v, Object o) {
		...
		if (lv && lo) {
			return ((Unwrappable<?>)v).unwrap() == ((Unwrappable<?>)o).unwrap();
		}
	...
	protected boolean isJavaObject(Object v) {
		return !(v instanceof JscObject) && !v.getClass().isPrimitive();
	}
}
