...
final class JscNumber extends JsNumber implements
	Iterable<JsNumber.Mid>, Like<NumberLike<?>>, LikeObject, Unwrappable<JscObject>
{
	public JscNumber(JscObject var) {
		super((Object)var);
	}
	public JscNumber(NumberLike<?> var, ObjectLike objectLike) {
		this(new JscObject(var, objectLike));
	}
	public JscNumber(NumberLike<?> var) {
		this(var, Js.object());
	}
	...
	public final NumberLike<?> like() {
		return (NumberLike<?>)unwrap().like();
	}
