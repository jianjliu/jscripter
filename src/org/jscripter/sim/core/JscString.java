...
final class JscString extends JsString implements
	Iterable<JsString.Mid>, Like<StringLike>, LikeObject, Unwrappable<JscObject>
{
	public JscString(JscObject var) {
		super((Object)var);
	}
	public JscString(StringLike var, ObjectLike objectLike) {
		this(new JscObject(var, objectLike));
	}
	public JscString(StringLike var) {
		this(var, Js.object());
	}
	...
	public final StringLike like() {
		return (StringLike)unwrap().like();
	}
